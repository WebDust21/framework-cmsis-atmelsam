...
#ifndef _SAMR21_PM_COMPONENT_H_
#define _SAMR21_PM_COMPONENT_H_
...
#define PM_APBCMASK_Msk                       _UINT32_(0x001B3FFF)                                 /* (PM_APBCMASK) Register Mask  */
