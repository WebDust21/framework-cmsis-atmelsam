...
#ifndef _SAMR21E17A_H_
#define _SAMR21E17A_H_
...
/* ************************************************************************** */
/*   INSTANCE DEFINITIONS FOR SAMR21E17A */
/* ************************************************************************** */
...
#define ID_RFCTRL        ( 85) /* RF233 control module (RFCTRL) */

#define ID_PERIPH_MAX    ( 85) /* Number of peripheral IDs */

/* ************************************************************************** */
/*   REGISTER STRUCTURE ADDRESS DEFINITIONS FOR SAMR21E17A                    */
/* ************************************************************************** */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
...
#define RFCTRL_REGS                      ((rfctrl_registers_t*)0x42005400)             /* RFCTRL Registers Address     */
...
#define RFCTRL_BASE_ADDRESS              _UINT32_(0x42005400)                          /* RFCTRL Base Address */
...
/* ************************************************************************** */
/*   PIO DEFINITIONS FOR SAMR21E17A                                           */
/* ************************************************************************** */
...
#define AUX0_SIZE                      _UINT32_(0x00000100)    /*    0kB Memory segment type: user_page */
...
#define AUX0_ADDR                      _UINT32_(0x00804000)    /* AUX0 base address (type: user_page)*/
...
/* ************************************************************************** */
/*   DEVICE SIGNATURES FOR SAMR21E17A                                         */
/* ************************************************************************** */
#define CHIP_DSU_DID                   _UINT32_(0X1001031D)
...
/* ************************************************************************** */
/* Event Generator IDs for SAMR21E17A */
/* ************************************************************************** */
