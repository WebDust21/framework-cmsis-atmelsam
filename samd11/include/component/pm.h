...
#define PM_CTRL_CFDEN(value)                  (PM_CTRL_CFDEN_Msk & (_UINT8_(value) << PM_CTRL_CFDEN_Pos)) /* Assignment of value for CFDEN in the PM_CTRL register */
...
#define PM_CTRL_BKUPCLK(value)                (PM_CTRL_BKUPCLK_Msk & (_UINT8_(value) << PM_CTRL_BKUPCLK_Pos)) /* Assignment of value for BKUPCLK in the PM_CTRL register */
...
#define PM_INTENCLR_CFD(value)                (PM_INTENCLR_CFD_Msk & (_UINT8_(value) << PM_INTENCLR_CFD_Pos)) /* Assignment of value for CFD in the PM_INTENCLR register */
...
#define PM_INTENSET_CFD(value)                (PM_INTENSET_CFD_Msk & (_UINT8_(value) << PM_INTENSET_CFD_Pos)) /* Assignment of value for CFD in the PM_INTENSET register */
...
#define PM_INTFLAG_CFD(value)                 (PM_INTFLAG_CFD_Msk & (_UINT8_(value) << PM_INTFLAG_CFD_Pos)) /* Assignment of value for CFD in the PM_INTFLAG register */
