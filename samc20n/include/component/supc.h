...
#ifndef _SAMC20_SUPC_COMPONENT_H_
#define _SAMC20_SUPC_COMPONENT_H_
...
#define SUPC_INTENCLR_VREG33RDY(value)        (SUPC_INTENCLR_VREG33RDY_Msk & (_UINT32_(value) << SUPC_INTENCLR_VREG33RDY_Pos)) /* Assignment of value for VREG33RDY in the SUPC_INTENCLR register */
...
#define SUPC_INTENSET_VREG33RDY(value)        (SUPC_INTENSET_VREG33RDY_Msk & (_UINT32_(value) << SUPC_INTENSET_VREG33RDY_Pos)) /* Assignment of value for VREG33RDY in the SUPC_INTENSET register */
...
#define SUPC_INTFLAG_VREG33RDY(value)         (SUPC_INTFLAG_VREG33RDY_Msk & (_UINT32_(value) << SUPC_INTFLAG_VREG33RDY_Pos)) /* Assignment of value for VREG33RDY in the SUPC_INTFLAG register */
...
#define SUPC_STATUS_VREG33RDY(value)          (SUPC_STATUS_VREG33RDY_Msk & (_UINT32_(value) << SUPC_STATUS_VREG33RDY_Pos)) /* Assignment of value for VREG33RDY in the SUPC_STATUS register */
...
#define SUPC_VREG33_ENABLE(value)             (SUPC_VREG33_ENABLE_Msk & (_UINT32_(value) << SUPC_VREG33_ENABLE_Pos)) /* Assignment of value for ENABLE in the SUPC_VREG33 register */
...
#define SUPC_VREG33_ENRDY(value)              (SUPC_VREG33_ENRDY_Msk & (_UINT32_(value) << SUPC_VREG33_ENRDY_Pos)) /* Assignment of value for ENRDY in the SUPC_VREG33 register */
...
#define SUPC_VREG33_BYPASS(value)             (SUPC_VREG33_BYPASS_Msk & (_UINT32_(value) << SUPC_VREG33_BYPASS_Pos)) /* Assignment of value for BYPASS in the SUPC_VREG33 register */
...
#define SUPC_VREG33_ISOEN(value)              (SUPC_VREG33_ISOEN_Msk & (_UINT32_(value) << SUPC_VREG33_ISOEN_Pos)) /* Assignment of value for ISOEN in the SUPC_VREG33 register */
...
#endif /* _SAMC20_SUPC_COMPONENT_H_ */
