...
/* ************************************************************************** */
/*   INSTANCE DEFINITIONS FOR SAMG54J19 */
/* ************************************************************************** */
...
/* ************************************************************************** */
/*   REGISTER STRUCTURE ADDRESS DEFINITIONS FOR SAMG54J19                     */
/* ************************************************************************** */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
...
#define CHIP_CIDR                      _UINT32_(0X247E0AE6)
...
#define CHIP_FREQ_CPU_MAX              _UINT32_(96000000)  
#define CHIP_FREQ_XTAL_32K             _UINT32_(32768)     
#define CHIP_FLASH_WRITE_WAIT_STATE    _UINT32_(7)         /* Embedded Flash Write Wait State */
#define CHIP_FREQ_FWS_0                _UINT32_(12500000)  /* Maximum operating frequency when FWS is 0 */
...
#define CHIP_FREQ_FWS_3                _UINT32_(51000000)  /* Maximum operating frequency when FWS is 3 */
#define CHIP_FREQ_FWS_4                _UINT32_(64000000)  /* Maximum operating frequency when FWS is 4 */
#define CHIP_FREQ_FWS_5                _UINT32_(76000000)  /* Maximum operating frequency when FWS is 5 */
#define CHIP_FREQ_FWS_6                _UINT32_(88000000)  /* Maximum operating frequency when FWS is 6 */
#define CHIP_FREQ_FWS_7                _UINT32_(96000000)  /* Maximum operating frequency when FWS is 7 */
#define CHIP_FREQ_FWS_NUMBER           _UINT32_(8)         /* Number of FWS ranges */
