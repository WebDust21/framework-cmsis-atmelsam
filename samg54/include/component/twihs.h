...
#define TWIHS_CR_Msk                          _UINT32_(0x0000FFFF)                                 /* (TWIHS_CR) Register Mask  */
...
#define TWIHS_SR_Msk                          _UINT32_(0x033DFFFF)                                 /* (TWIHS_SR) Register Mask  */
...
#define TWIHS_IER_Msk                         _UINT32_(0x003DFFF7)                                 /* (TWIHS_IER) Register Mask  */
...
#define TWIHS_IDR_Msk                         _UINT32_(0x003DFFF7)                                 /* (TWIHS_IDR) Register Mask  */
...
#define TWIHS_IMR_Msk                         _UINT32_(0x003DFFF7)                                 /* (TWIHS_IMR) Register Mask  */
