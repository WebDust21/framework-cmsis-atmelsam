...
#define TC_CMR_CAPTURE_Msk                    _UINT32_(0x000F47C0)                                  /* (TC_CMR_CAPTURE) Register Mask  */
...
#define TC_RPR0_REG_OFST               _UINT32_(0x100)     /* (TC_RPR0) Receive Pointer Register (pdc = 0) Offset */
#define TC_RNPR0_REG_OFST              _UINT32_(0x110)     /* (TC_RNPR0) Receive Next Pointer Register (pdc = 0) Offset */
#define TC_RNCR0_REG_OFST              _UINT32_(0x114)     /* (TC_RNCR0) Receive Next Counter Register (pdc = 0) Offset */
#define TC_PTCR0_REG_OFST              _UINT32_(0x120)     /* (TC_PTCR0) Transfer Control Register (pdc = 0) Offset */
#define TC_PTSR0_REG_OFST              _UINT32_(0x124)     /* (TC_PTSR0) Transfer Status Register (pdc = 0) Offset */
...
typedef struct
{
  ...
  __IO  uint32_t                       TC_RPR0;            /**< Offset: 0x100 (R/W  32) Receive Pointer Register (pdc = 0) */
  __I   uint8_t                        Reserved3[0x0C];
  __IO  uint32_t                       TC_RNPR0;           /**< Offset: 0x110 (R/W  32) Receive Next Pointer Register (pdc = 0) */
  __IO  uint32_t                       TC_RNCR0;           /**< Offset: 0x114 (R/W  32) Receive Next Counter Register (pdc = 0) */
  __I   uint8_t                        Reserved4[0x08];
  __O   uint32_t                       TC_PTCR0;           /**< Offset: 0x120 ( /W  32) Transfer Control Register (pdc = 0) */
  __I   uint32_t                       TC_PTSR0;           /**< Offset: 0x124 (R/   32) Transfer Status Register (pdc = 0) */
} tc_registers_t;
