...
#define UART_IER_Msk                          _UINT32_(0x00009AFB)                                 /* (UART_IER) Register Mask  */
...
#define UART_IDR_Msk                          _UINT32_(0x00009AFB)                                 /* (UART_IDR) Register Mask  */
...
#define UART_IMR_Msk                          _UINT32_(0x00009AFB)                                 /* (UART_IMR) Register Mask  */
...
#define UART_SR_Msk                           _UINT32_(0x00009AFB)                                 /* (UART_SR) Register Mask  */
