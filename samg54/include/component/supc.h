...
#define SUPC_MR_VDDSEL_Pos                    _UINT32_(8)                                          /* (SUPC_MR) VRVDD Field Selection Position */
#define SUPC_MR_VDDSEL_Msk                    (_UINT32_(0x1) << SUPC_MR_VDDSEL_Pos)                /* (SUPC_MR) VRVDD Field Selection Mask */
#define SUPC_MR_VDDSEL(value)                 (SUPC_MR_VDDSEL_Msk & (_UINT32_(value) << SUPC_MR_VDDSEL_Pos)) /* Assigment of value for VDDSEL in the SUPC_MR register */
#define   SUPC_MR_VDDSEL_FACTORY_Val          _UINT32_(0x0)                                        /* (SUPC_MR) The voltage regulator output value is the factory-programmed value.  */
#define   SUPC_MR_VDDSEL_USER_VRVDD_Val       _UINT32_(0x1)                                        /* (SUPC_MR) The voltage regulator output value is defined by the value programmed in the field VRVDD.  */
...
#define SUPC_MR_VRVDD_Pos                     _UINT32_(9)                                          /* (SUPC_MR) VRVDD Field Selection Position */
#define SUPC_MR_VRVDD_Msk                     (_UINT32_(0x7) << SUPC_MR_VRVDD_Pos)                 /* (SUPC_MR) VRVDD Field Selection Mask */
#define SUPC_MR_VRVDD(value)                  (SUPC_MR_VRVDD_Msk & (_UINT32_(value) << SUPC_MR_VRVDD_Pos)) /* Assigment of value for VRVDD in the SUPC_MR register */
#define   SUPC_MR_VRVDD_FACTORY_Val           _UINT32_(0x0)                                        /* (SUPC_MR) The voltage regulator output value is the factory-programmed value.  */
#define   SUPC_MR_VRVDD_USER_VRVDD_Val        _UINT32_(0x1)                                        /* (SUPC_MR) The voltage regulator output value is defined by the value programmed in the field VRVDD.  */
...
#define SUPC_MR_Msk                           _UINT32_(0xFFD03F00)                                 /* (SUPC_MR) Register Mask  */
