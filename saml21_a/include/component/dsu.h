...
#define DSU_DID_RESETVALUE                    _UINT32_(0x10810000)                                 /*  (DSU_DID) Device Identification  Reset Value */
...
#define DSU_CID0_RESETVALUE                   _UINT32_(0x00)                                       /*  (DSU_CID0) Component Identification 0  Reset Value */
...
#define DSU_CID1_RESETVALUE                   _UINT32_(0x0D)                                       /*  (DSU_CID1) Component Identification 1  Reset Value */
...
#define DSU_CID2_RESETVALUE                   _UINT32_(0x10)                                       /*  (DSU_CID2) Component Identification 2  Reset Value */
