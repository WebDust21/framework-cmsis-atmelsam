...
#define FUSES_OTP5_WORD_0_ADC_BIASREFBUF(value) (FUSES_OTP5_WORD_0_ADC_BIASREFBUF_Msk & (_UINT32_(value) << FUSES_OTP5_WORD_0_ADC_BIASREFBUF_Pos)) /* Assignment of value for ADC_BIASREFBUF in the FUSES_OTP5_WORD_0 register */
...
#define FUSES_OTP5_WORD_0_ADC_BIASCOMP(value) (FUSES_OTP5_WORD_0_ADC_BIASCOMP_Msk & (_UINT32_(value) << FUSES_OTP5_WORD_0_ADC_BIASCOMP_Pos)) /* Assignment of value for ADC_BIASCOMP in the FUSES_OTP5_WORD_0 register */
...
#define FUSES_OTP5_WORD_0_USB_TRANSN(value)   (FUSES_OTP5_WORD_0_USB_TRANSN_Msk & (_UINT32_(value) << FUSES_OTP5_WORD_0_USB_TRANSN_Pos)) /* Assignment of value for USB_TRANSN in the FUSES_OTP5_WORD_0 register */
...
#define FUSES_OTP5_WORD_0_USB_TRANSP(value)   (FUSES_OTP5_WORD_0_USB_TRANSP_Msk & (_UINT32_(value) << FUSES_OTP5_WORD_0_USB_TRANSP_Pos)) /* Assignment of value for USB_TRANSP in the FUSES_OTP5_WORD_0 register */
...
#define FUSES_OTP5_WORD_0_USB_TRIM(value)     (FUSES_OTP5_WORD_0_USB_TRIM_Msk & (_UINT32_(value) << FUSES_OTP5_WORD_0_USB_TRIM_Pos)) /* Assignment of value for USB_TRIM in the FUSES_OTP5_WORD_0 register */
...
#define FUSES_USER_WORD_0_BOD12_DIS(value)    (FUSES_USER_WORD_0_BOD12_DIS_Msk & (_UINT32_(value) << FUSES_USER_WORD_0_BOD12_DIS_Pos)) /* Assignment of value for BOD12_DIS in the FUSES_USER_WORD_0 register */
...
#define FUSES_USER_WORD_1_BOD12_HYST(value)   (FUSES_USER_WORD_1_BOD12_HYST_Msk & (_UINT32_(value) << FUSES_USER_WORD_1_BOD12_HYST_Pos)) /* Assignment of value for BOD12_HYST in the FUSES_USER_WORD_1 register */
