...
#define ADC_SYNCBUSY_AVGCTRL_Pos              _UINT16_(2)                                          /* (ADC_SYNCBUSY) AVGCTRL Synchronization Busy Position */
...
#define ADC_SYNCBUSY_SAMPCTRL_Pos             _UINT16_(3)                                          /* (ADC_SYNCBUSY) SAMPCTRL Synchronization Busy Position */
...
#define ADC_SYNCBUSY_CTRLC_Pos                _UINT16_(4)                                          /* (ADC_SYNCBUSY) CTRLC Synchronization Busy Position */
...
#define ADC_SYNCBUSY_INPUTCTRL_Pos            _UINT16_(5)                                          /* (ADC_SYNCBUSY) INPUTCTRL Synchronization Busy Position */
...
#define ADC_SYNCBUSY_OFFSETCORR_Pos           _UINT16_(6)                                          /* (ADC_SYNCBUSY) OFFSETCTRL Synchronization Busy Position */
...
#define ADC_SYNCBUSY_GAINCORR_Pos             _UINT16_(7)                                          /* (ADC_SYNCBUSY) GAINCORR Synchronization Busy Position */
...
#define ADC_SYNCBUSY_WINLT_Pos                _UINT16_(8)                                          /* (ADC_SYNCBUSY) WINLT Synchronization Busy Position */
...
#define ADC_SYNCBUSY_WINUT_Pos                _UINT16_(9)                                          /* (ADC_SYNCBUSY) WINUT Synchronization Busy Position */
