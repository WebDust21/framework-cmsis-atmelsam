...
#define TCC_CTRLA_Msk                         _UINT32_(0x0F00FF63)                                 /* (TCC_CTRLA) Register Mask  */
...
#define TCC_STATUS_WAVEBUFV_Pos               _UINT32_(6)                                          /* (TCC_STATUS) Wave Buffer Valid Position */
#define TCC_STATUS_WAVEBUFV_Msk               (_UINT32_(0x1) << TCC_STATUS_WAVEBUFV_Pos)           /* (TCC_STATUS) Wave Buffer Valid Mask */
#define TCC_STATUS_WAVEBUFV(value)            (TCC_STATUS_WAVEBUFV_Msk & (_UINT32_(value) << TCC_STATUS_WAVEBUFV_Pos)) /* Assignment of value for WAVEBUFV in the TCC_STATUS register */
...
#define TCC_WAVEBUF_RESETVALUE                _UINT32_(0x00)                                       /*  (TCC_WAVEBUF) Waveform Control Buffer  Reset Value */

#define TCC_WAVEBUF_WAVEGENB_Pos              _UINT32_(0)                                          /* (TCC_WAVEBUF) Waveform Generation Buffer Position */
#define TCC_WAVEBUF_WAVEGENB_Msk              (_UINT32_(0x7) << TCC_WAVEBUF_WAVEGENB_Pos)          /* (TCC_WAVEBUF) Waveform Generation Buffer Mask */
#define TCC_WAVEBUF_WAVEGENB(value)           (TCC_WAVEBUF_WAVEGENB_Msk & (_UINT32_(value) << TCC_WAVEBUF_WAVEGENB_Pos)) /* Assignment of value for WAVEGENB in the TCC_WAVEBUF register */
#define   TCC_WAVEBUF_WAVEGENB_NFRQ_Val       _UINT32_(0x0)                                        /* (TCC_WAVEBUF) Normal frequency  */
#define   TCC_WAVEBUF_WAVEGENB_MFRQ_Val       _UINT32_(0x1)                                        /* (TCC_WAVEBUF) Match frequency  */
#define   TCC_WAVEBUF_WAVEGENB_NPWM_Val       _UINT32_(0x2)                                        /* (TCC_WAVEBUF) Normal PWM  */
#define   TCC_WAVEBUF_WAVEGENB_DSCRITICAL_Val _UINT32_(0x4)                                        /* (TCC_WAVEBUF) Dual-slope critical  */
#define   TCC_WAVEBUF_WAVEGENB_DSBOTTOM_Val   _UINT32_(0x5)                                        /* (TCC_WAVEBUF) Dual-slope with interrupt/event condition when COUNT reaches ZERO  */
#define   TCC_WAVEBUF_WAVEGENB_DSBOTH_Val     _UINT32_(0x6)                                        /* (TCC_WAVEBUF) Dual-slope with interrupt/event condition when COUNT reaches ZERO or TOP  */
#define   TCC_WAVEBUF_WAVEGENB_DSTOP_Val      _UINT32_(0x7)                                        /* (TCC_WAVEBUF) Dual-slope with interrupt/event condition when COUNT reaches TOP  */
#define TCC_WAVEBUF_WAVEGENB_NFRQ             (TCC_WAVEBUF_WAVEGENB_NFRQ_Val << TCC_WAVEBUF_WAVEGENB_Pos) /* (TCC_WAVEBUF) Normal frequency Position */
#define TCC_WAVEBUF_WAVEGENB_MFRQ             (TCC_WAVEBUF_WAVEGENB_MFRQ_Val << TCC_WAVEBUF_WAVEGENB_Pos) /* (TCC_WAVEBUF) Match frequency Position */
#define TCC_WAVEBUF_WAVEGENB_NPWM             (TCC_WAVEBUF_WAVEGENB_NPWM_Val << TCC_WAVEBUF_WAVEGENB_Pos) /* (TCC_WAVEBUF) Normal PWM Position */
#define TCC_WAVEBUF_WAVEGENB_DSCRITICAL       (TCC_WAVEBUF_WAVEGENB_DSCRITICAL_Val << TCC_WAVEBUF_WAVEGENB_Pos) /* (TCC_WAVEBUF) Dual-slope critical Position */
#define TCC_WAVEBUF_WAVEGENB_DSBOTTOM         (TCC_WAVEBUF_WAVEGENB_DSBOTTOM_Val << TCC_WAVEBUF_WAVEGENB_Pos) /* (TCC_WAVEBUF) Dual-slope with interrupt/event condition when COUNT reaches ZERO Position */
#define TCC_WAVEBUF_WAVEGENB_DSBOTH           (TCC_WAVEBUF_WAVEGENB_DSBOTH_Val << TCC_WAVEBUF_WAVEGENB_Pos) /* (TCC_WAVEBUF) Dual-slope with interrupt/event condition when COUNT reaches ZERO or TOP Position */
#define TCC_WAVEBUF_WAVEGENB_DSTOP            (TCC_WAVEBUF_WAVEGENB_DSTOP_Val << TCC_WAVEBUF_WAVEGENB_Pos) /* (TCC_WAVEBUF) Dual-slope with interrupt/event condition when COUNT reaches TOP Position */
#define TCC_WAVEBUF_RAMPB_Pos                 _UINT32_(4)                                          /* (TCC_WAVEBUF) Ramp Mode Buffer Position */
#define TCC_WAVEBUF_RAMPB_Msk                 (_UINT32_(0x3) << TCC_WAVEBUF_RAMPB_Pos)             /* (TCC_WAVEBUF) Ramp Mode Buffer Mask */
#define TCC_WAVEBUF_RAMPB(value)              (TCC_WAVEBUF_RAMPB_Msk & (_UINT32_(value) << TCC_WAVEBUF_RAMPB_Pos)) /* Assignment of value for RAMPB in the TCC_WAVEBUF register */
#define TCC_WAVEBUF_CIPERENB_Pos              _UINT32_(7)                                          /* (TCC_WAVEBUF) Circular Period Enable Buffer Position */
#define TCC_WAVEBUF_CIPERENB_Msk              (_UINT32_(0x1) << TCC_WAVEBUF_CIPERENB_Pos)          /* (TCC_WAVEBUF) Circular Period Enable Buffer Mask */
#define TCC_WAVEBUF_CIPERENB(value)           (TCC_WAVEBUF_CIPERENB_Msk & (_UINT32_(value) << TCC_WAVEBUF_CIPERENB_Pos)) /* Assignment of value for CIPERENB in the TCC_WAVEBUF register */
#define TCC_WAVEBUF_CICCENB0_Pos              _UINT32_(8)                                          /* (TCC_WAVEBUF) Circular Channel 0 Enable Buffer Position */
#define TCC_WAVEBUF_CICCENB0_Msk              (_UINT32_(0x1) << TCC_WAVEBUF_CICCENB0_Pos)          /* (TCC_WAVEBUF) Circular Channel 0 Enable Buffer Mask */
#define TCC_WAVEBUF_CICCENB0(value)           (TCC_WAVEBUF_CICCENB0_Msk & (_UINT32_(value) << TCC_WAVEBUF_CICCENB0_Pos)) /* Assignment of value for CICCENB0 in the TCC_WAVEBUF register */
#define TCC_WAVEBUF_CICCENB1_Pos              _UINT32_(9)                                          /* (TCC_WAVEBUF) Circular Channel 1 Enable Buffer Position */
#define TCC_WAVEBUF_CICCENB1_Msk              (_UINT32_(0x1) << TCC_WAVEBUF_CICCENB1_Pos)          /* (TCC_WAVEBUF) Circular Channel 1 Enable Buffer Mask */
#define TCC_WAVEBUF_CICCENB1(value)           (TCC_WAVEBUF_CICCENB1_Msk & (_UINT32_(value) << TCC_WAVEBUF_CICCENB1_Pos)) /* Assignment of value for CICCENB1 in the TCC_WAVEBUF register */
#define TCC_WAVEBUF_CICCENB2_Pos              _UINT32_(10)                                         /* (TCC_WAVEBUF) Circular Channel 2 Enable Buffer Position */
#define TCC_WAVEBUF_CICCENB2_Msk              (_UINT32_(0x1) << TCC_WAVEBUF_CICCENB2_Pos)          /* (TCC_WAVEBUF) Circular Channel 2 Enable Buffer Mask */
#define TCC_WAVEBUF_CICCENB2(value)           (TCC_WAVEBUF_CICCENB2_Msk & (_UINT32_(value) << TCC_WAVEBUF_CICCENB2_Pos)) /* Assignment of value for CICCENB2 in the TCC_WAVEBUF register */
#define TCC_WAVEBUF_CICCENB3_Pos              _UINT32_(11)                                         /* (TCC_WAVEBUF) Circular Channel 3 Enable Buffer Position */
#define TCC_WAVEBUF_CICCENB3_Msk              (_UINT32_(0x1) << TCC_WAVEBUF_CICCENB3_Pos)          /* (TCC_WAVEBUF) Circular Channel 3 Enable Buffer Mask */
#define TCC_WAVEBUF_CICCENB3(value)           (TCC_WAVEBUF_CICCENB3_Msk & (_UINT32_(value) << TCC_WAVEBUF_CICCENB3_Pos)) /* Assignment of value for CICCENB3 in the TCC_WAVEBUF register */
#define TCC_WAVEBUF_POLB0_Pos                 _UINT32_(16)                                         /* (TCC_WAVEBUF) Channel 0 Polarity Buffer Position */
#define TCC_WAVEBUF_POLB0_Msk                 (_UINT32_(0x1) << TCC_WAVEBUF_POLB0_Pos)             /* (TCC_WAVEBUF) Channel 0 Polarity Buffer Mask */
#define TCC_WAVEBUF_POLB0(value)              (TCC_WAVEBUF_POLB0_Msk & (_UINT32_(value) << TCC_WAVEBUF_POLB0_Pos)) /* Assignment of value for POLB0 in the TCC_WAVEBUF register */
#define TCC_WAVEBUF_POLB1_Pos                 _UINT32_(17)                                         /* (TCC_WAVEBUF) Channel 1 Polarity Buffer Position */
#define TCC_WAVEBUF_POLB1_Msk                 (_UINT32_(0x1) << TCC_WAVEBUF_POLB1_Pos)             /* (TCC_WAVEBUF) Channel 1 Polarity Buffer Mask */
#define TCC_WAVEBUF_POLB1(value)              (TCC_WAVEBUF_POLB1_Msk & (_UINT32_(value) << TCC_WAVEBUF_POLB1_Pos)) /* Assignment of value for POLB1 in the TCC_WAVEBUF register */
#define TCC_WAVEBUF_POLB2_Pos                 _UINT32_(18)                                         /* (TCC_WAVEBUF) Channel 2 Polarity Buffer Position */
#define TCC_WAVEBUF_POLB2_Msk                 (_UINT32_(0x1) << TCC_WAVEBUF_POLB2_Pos)             /* (TCC_WAVEBUF) Channel 2 Polarity Buffer Mask */
#define TCC_WAVEBUF_POLB2(value)              (TCC_WAVEBUF_POLB2_Msk & (_UINT32_(value) << TCC_WAVEBUF_POLB2_Pos)) /* Assignment of value for POLB2 in the TCC_WAVEBUF register */
#define TCC_WAVEBUF_POLB3_Pos                 _UINT32_(19)                                         /* (TCC_WAVEBUF) Channel 3 Polarity Buffer Position */
#define TCC_WAVEBUF_POLB3_Msk                 (_UINT32_(0x1) << TCC_WAVEBUF_POLB3_Pos)             /* (TCC_WAVEBUF) Channel 3 Polarity Buffer Mask */
#define TCC_WAVEBUF_POLB3(value)              (TCC_WAVEBUF_POLB3_Msk & (_UINT32_(value) << TCC_WAVEBUF_POLB3_Pos)) /* Assignment of value for POLB3 in the TCC_WAVEBUF register */
#define TCC_WAVEBUF_SWAPB0_Pos                _UINT32_(24)                                         /* (TCC_WAVEBUF) Swap DTI Output Pair 0 Buffer Position */
#define TCC_WAVEBUF_SWAPB0_Msk                (_UINT32_(0x1) << TCC_WAVEBUF_SWAPB0_Pos)            /* (TCC_WAVEBUF) Swap DTI Output Pair 0 Buffer Mask */
#define TCC_WAVEBUF_SWAPB0(value)             (TCC_WAVEBUF_SWAPB0_Msk & (_UINT32_(value) << TCC_WAVEBUF_SWAPB0_Pos)) /* Assignment of value for SWAPB0 in the TCC_WAVEBUF register */
#define TCC_WAVEBUF_SWAPB1_Pos                _UINT32_(25)                                         /* (TCC_WAVEBUF) Swap DTI Output Pair 1 Buffer Position */
#define TCC_WAVEBUF_SWAPB1_Msk                (_UINT32_(0x1) << TCC_WAVEBUF_SWAPB1_Pos)            /* (TCC_WAVEBUF) Swap DTI Output Pair 1 Buffer Mask */
#define TCC_WAVEBUF_SWAPB1(value)             (TCC_WAVEBUF_SWAPB1_Msk & (_UINT32_(value) << TCC_WAVEBUF_SWAPB1_Pos)) /* Assignment of value for SWAPB1 in the TCC_WAVEBUF register */
#define TCC_WAVEBUF_SWAPB2_Pos                _UINT32_(26)                                         /* (TCC_WAVEBUF) Swap DTI Output Pair 2 Buffer Position */
#define TCC_WAVEBUF_SWAPB2_Msk                (_UINT32_(0x1) << TCC_WAVEBUF_SWAPB2_Pos)            /* (TCC_WAVEBUF) Swap DTI Output Pair 2 Buffer Mask */
#define TCC_WAVEBUF_SWAPB2(value)             (TCC_WAVEBUF_SWAPB2_Msk & (_UINT32_(value) << TCC_WAVEBUF_SWAPB2_Pos)) /* Assignment of value for SWAPB2 in the TCC_WAVEBUF register */
#define TCC_WAVEBUF_SWAPB3_Pos                _UINT32_(27)                                         /* (TCC_WAVEBUF) Swap DTI Output Pair 3 Buffer Position */
#define TCC_WAVEBUF_SWAPB3_Msk                (_UINT32_(0x1) << TCC_WAVEBUF_SWAPB3_Pos)            /* (TCC_WAVEBUF) Swap DTI Output Pair 3 Buffer Mask */
#define TCC_WAVEBUF_SWAPB3(value)             (TCC_WAVEBUF_SWAPB3_Msk & (_UINT32_(value) << TCC_WAVEBUF_SWAPB3_Pos)) /* Assignment of value for SWAPB3 in the TCC_WAVEBUF register */
#define TCC_WAVEBUF_Msk                       _UINT32_(0x0F0F0FB7)                                 /* (TCC_WAVEBUF) Register Mask  */

#define TCC_WAVEBUF_CICCENB_Pos               _UINT32_(8)                                          /* (TCC_WAVEBUF Position) Circular Channel x Enable Buffer */
#define TCC_WAVEBUF_CICCENB_Msk               (_UINT32_(0xF) << TCC_WAVEBUF_CICCENB_Pos)           /* (TCC_WAVEBUF Mask) CICCENB */
#define TCC_WAVEBUF_CICCENB(value)            (TCC_WAVEBUF_CICCENB_Msk & (_UINT32_(value) << TCC_WAVEBUF_CICCENB_Pos)) 
#define TCC_WAVEBUF_POLB_Pos                  _UINT32_(16)                                         /* (TCC_WAVEBUF Position) Channel x Polarity Buffer */
#define TCC_WAVEBUF_POLB_Msk                  (_UINT32_(0xF) << TCC_WAVEBUF_POLB_Pos)              /* (TCC_WAVEBUF Mask) POLB */
#define TCC_WAVEBUF_POLB(value)               (TCC_WAVEBUF_POLB_Msk & (_UINT32_(value) << TCC_WAVEBUF_POLB_Pos)) 
#define TCC_WAVEBUF_SWAPB_Pos                 _UINT32_(24)                                         /* (TCC_WAVEBUF Position) Swap DTI Output Pair 3 Buffer */
#define TCC_WAVEBUF_SWAPB_Msk                 (_UINT32_(0xF) << TCC_WAVEBUF_SWAPB_Pos)             /* (TCC_WAVEBUF Mask) SWAPB */
#define TCC_WAVEBUF_SWAPB(value)              (TCC_WAVEBUF_SWAPB_Msk & (_UINT32_(value) << TCC_WAVEBUF_SWAPB_Pos)) 
...
#define TCC_WAVEBUF_REG_OFST           _UINT32_(0x68)      /* (TCC_WAVEBUF) Waveform Control Buffer Offset */
...
{  /* Timer Counter Control */
  ...
  __IO  uint32_t                       TCC_WAVEBUF;        /* Offset: 0x68 (R/W  32) Waveform Control Buffer */
