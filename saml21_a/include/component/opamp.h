...
#define OPAMP_OPAMPCTRL_ENABLE(value)         (OPAMP_OPAMPCTRL_ENABLE_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL_ENABLE_Pos)) /* Assignment of value for ENABLE in the OPAMP_OPAMPCTRL register */
...
#define OPAMP_OPAMPCTRL_ANAOUT(value)         (OPAMP_OPAMPCTRL_ANAOUT_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL_ANAOUT_Pos)) /* Assignment of value for ANAOUT in the OPAMP_OPAMPCTRL register */
...
#define OPAMP_OPAMPCTRL_BIAS(value)           (OPAMP_OPAMPCTRL_BIAS_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL_BIAS_Pos)) /* Assignment of value for BIAS in the OPAMP_OPAMPCTRL register */
...
#define OPAMP_OPAMPCTRL_RUNSTDBY(value)       (OPAMP_OPAMPCTRL_RUNSTDBY_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL_RUNSTDBY_Pos)) /* Assignment of value for RUNSTDBY in the OPAMP_OPAMPCTRL register */
...
#define OPAMP_OPAMPCTRL_ONDEMAND(value)       (OPAMP_OPAMPCTRL_ONDEMAND_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL_ONDEMAND_Pos)) /* Assignment of value for ONDEMAND in the OPAMP_OPAMPCTRL register */
...
#define OPAMP_OPAMPCTRL_RES2OUT(value)        (OPAMP_OPAMPCTRL_RES2OUT_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL_RES2OUT_Pos)) /* Assignment of value for RES2OUT in the OPAMP_OPAMPCTRL register */
...
#define OPAMP_OPAMPCTRL_RES2VCC(value)        (OPAMP_OPAMPCTRL_RES2VCC_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL_RES2VCC_Pos)) /* Assignment of value for RES2VCC in the OPAMP_OPAMPCTRL register */
...
#define OPAMP_OPAMPCTRL_RES1EN(value)         (OPAMP_OPAMPCTRL_RES1EN_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL_RES1EN_Pos)) /* Assignment of value for RES1EN in the OPAMP_OPAMPCTRL register */
...
#define OPAMP_OPAMPCTRL_RES1MUX(value)        (OPAMP_OPAMPCTRL_RES1MUX_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL_RES1MUX_Pos)) /* Assignment of value for RES1MUX in the OPAMP_OPAMPCTRL register */
...
#define OPAMP_OPAMPCTRL_POTMUX(value)         (OPAMP_OPAMPCTRL_POTMUX_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL_POTMUX_Pos)) /* Assignment of value for POTMUX in the OPAMP_OPAMPCTRL register */
...
#define OPAMP_OPAMPCTRL_MUXPOS(value)         (OPAMP_OPAMPCTRL_MUXPOS_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL_MUXPOS_Pos)) /* Assignment of value for MUXPOS in the OPAMP_OPAMPCTRL register */
...
#define OPAMP_OPAMPCTRL_MUXNEG(value)         (OPAMP_OPAMPCTRL_MUXNEG_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL_MUXNEG_Pos)) /* Assignment of value for MUXNEG in the OPAMP_OPAMPCTRL register */
