...
#define MCLK_CTRLA_CFDEN_Pos                  _UINT8_(2)                                           /* (MCLK_CTRLA) Clock Failure Detector Enable Position */
#define MCLK_CTRLA_CFDEN_Msk                  (_UINT8_(0x1) << MCLK_CTRLA_CFDEN_Pos)               /* (MCLK_CTRLA) Clock Failure Detector Enable Mask */
#define MCLK_CTRLA_CFDEN(value)               (MCLK_CTRLA_CFDEN_Msk & (_UINT8_(value) << MCLK_CTRLA_CFDEN_Pos)) /* Assignment of value for CFDEN in the MCLK_CTRLA register */
#define MCLK_CTRLA_EMCLK_Pos                  _UINT8_(4)                                           /* (MCLK_CTRLA) Emergency Clock Select Position */
#define MCLK_CTRLA_EMCLK_Msk                  (_UINT8_(0x1) << MCLK_CTRLA_EMCLK_Pos)               /* (MCLK_CTRLA) Emergency Clock Select Mask */
#define MCLK_CTRLA_EMCLK(value)               (MCLK_CTRLA_EMCLK_Msk & (_UINT8_(value) << MCLK_CTRLA_EMCLK_Pos)) /* Assignment of value for EMCLK in the MCLK_CTRLA register */
#define MCLK_CTRLA_Msk                        _UINT8_(0x14)                                        /* (MCLK_CTRLA) Register Mask  */
...
#define MCLK_INTENCLR_CFD_Pos                 _UINT8_(1)                                           /* (MCLK_INTENCLR) Clock Failure Detector Interrupt Enable Position */
#define MCLK_INTENCLR_CFD_Msk                 (_UINT8_(0x1) << MCLK_INTENCLR_CFD_Pos)              /* (MCLK_INTENCLR) Clock Failure Detector Interrupt Enable Mask */
#define MCLK_INTENCLR_CFD(value)              (MCLK_INTENCLR_CFD_Msk & (_UINT8_(value) << MCLK_INTENCLR_CFD_Pos)) /* Assignment of value for CFD in the MCLK_INTENCLR register */
#define MCLK_INTENCLR_Msk                     _UINT8_(0x03)                                        /* (MCLK_INTENCLR) Register Mask  */
...
#define MCLK_INTENSET_CFD_Pos                 _UINT8_(1)                                           /* (MCLK_INTENSET) Clock Failure Detector Interrupt Enable Position */
#define MCLK_INTENSET_CFD_Msk                 (_UINT8_(0x1) << MCLK_INTENSET_CFD_Pos)              /* (MCLK_INTENSET) Clock Failure Detector Interrupt Enable Mask */
#define MCLK_INTENSET_CFD(value)              (MCLK_INTENSET_CFD_Msk & (_UINT8_(value) << MCLK_INTENSET_CFD_Pos)) /* Assignment of value for CFD in the MCLK_INTENSET register */
#define MCLK_INTENSET_Msk                     _UINT8_(0x03)                                        /* (MCLK_INTENSET) Register Mask  */
...
#define MCLK_INTFLAG_CFD_Pos                  _UINT8_(1)                                           /* (MCLK_INTFLAG) Clock Failure Detector Position */
#define MCLK_INTFLAG_CFD_Msk                  (_UINT8_(0x1) << MCLK_INTFLAG_CFD_Pos)               /* (MCLK_INTFLAG) Clock Failure Detector Mask */
#define MCLK_INTFLAG_CFD(value)               (MCLK_INTFLAG_CFD_Msk & (_UINT8_(value) << MCLK_INTFLAG_CFD_Pos)) /* Assignment of value for CFD in the MCLK_INTFLAG register */
#define MCLK_INTFLAG_Msk                      _UINT8_(0x03)                                        /* (MCLK_INTFLAG) Register Mask  */
...
#define MCLK_LPDIV_LPDIV(value)               (MCLK_LPDIV_LPDIV_Msk & (_UINT8_(value) << MCLK_LPDIV_LPDIV_Pos)) /* Assignment of value for LPDIV in the MCLK_LPDIV register */
...
#define MCLK_BUPDIV_BUPDIV(value)             (MCLK_BUPDIV_BUPDIV_Msk & (_UINT8_(value) << MCLK_BUPDIV_BUPDIV_Pos)) /* Assignment of value for BUPDIV in the MCLK_BUPDIV register */
...
#define MCLK_AHBMASK_HPB4(value)              (MCLK_AHBMASK_HPB4_Msk & (_UINT32_(value) << MCLK_AHBMASK_HPB4_Pos)) /* Assignment of value for HPB4 in the MCLK_AHBMASK register */
...
#define MCLK_AHBMASK_LPRAM(value)             (MCLK_AHBMASK_LPRAM_Msk & (_UINT32_(value) << MCLK_AHBMASK_LPRAM_Pos)) /* Assignment of value for LPRAM in the MCLK_AHBMASK register */
...
#define MCLK_AHBMASK_L2HBRIDGES_H(value)      (MCLK_AHBMASK_L2HBRIDGES_H_Msk & (_UINT32_(value) << MCLK_AHBMASK_L2HBRIDGES_H_Pos)) /* Assignment of value for L2HBRIDGES_H in the MCLK_AHBMASK register */
...
#define MCLK_AHBMASK_H2LBRIDGES_H(value)      (MCLK_AHBMASK_H2LBRIDGES_H_Msk & (_UINT32_(value) << MCLK_AHBMASK_H2LBRIDGES_H_Pos)) /* Assignment of value for H2LBRIDGES_H in the MCLK_AHBMASK register */
...
#define MCLK_AHBMASK_HSRAM_AHBSETUPKEEPER(value) (MCLK_AHBMASK_HSRAM_AHBSETUPKEEPER_Msk & (_UINT32_(value) << MCLK_AHBMASK_HSRAM_AHBSETUPKEEPER_Pos)) /* Assignment of value for HSRAM_AHBSETUPKEEPER in the MCLK_AHBMASK register */
...
#define MCLK_AHBMASK_HSRAM_HMATRIXLP2HMCRAMCHSBRIDGE(value) (MCLK_AHBMASK_HSRAM_HMATRIXLP2HMCRAMCHSBRIDGE_Msk & (_UINT32_(value) << MCLK_AHBMASK_HSRAM_HMATRIXLP2HMCRAMCHSBRIDGE_Pos)) /* Assignment of value for HSRAM_HMATRIXLP2HMCRAMCHSBRIDGE in the MCLK_AHBMASK register */
...
#define MCLK_APBAMASK_PORT(value)             (MCLK_APBAMASK_PORT_Msk & (_UINT32_(value) << MCLK_APBAMASK_PORT_Pos)) /* Assignment of value for PORT in the MCLK_APBAMASK register */
...
#define MCLK_APBDMASK_EVSYS(value)            (MCLK_APBDMASK_EVSYS_Msk & (_UINT32_(value) << MCLK_APBDMASK_EVSYS_Pos)) /* Assignment of value for EVSYS in the MCLK_APBDMASK register */
...
#define MCLK_APBDMASK_TC4(value)              (MCLK_APBDMASK_TC4_Msk & (_UINT32_(value) << MCLK_APBDMASK_TC4_Pos)) /* Assignment of value for TC4 in the MCLK_APBDMASK register */
...
#define MCLK_APBDMASK_ADC(value)              (MCLK_APBDMASK_ADC_Msk & (_UINT32_(value) << MCLK_APBDMASK_ADC_Pos)) /* Assignment of value for ADC in the MCLK_APBDMASK register */
...
#define MCLK_APBDMASK_AC(value)               (MCLK_APBDMASK_AC_Msk & (_UINT32_(value) << MCLK_APBDMASK_AC_Pos)) /* Assignment of value for AC in the MCLK_APBDMASK register */
...
#define MCLK_APBDMASK_PTC(value)              (MCLK_APBDMASK_PTC_Msk & (_UINT32_(value) << MCLK_APBDMASK_PTC_Pos)) /* Assignment of value for PTC in the MCLK_APBDMASK register */
...
#define MCLK_APBDMASK_OPAMP(value)            (MCLK_APBDMASK_OPAMP_Msk & (_UINT32_(value) << MCLK_APBDMASK_OPAMP_Pos)) /* Assignment of value for OPAMP in the MCLK_APBDMASK register */
...
#define MCLK_APBDMASK_CCL(value)              (MCLK_APBDMASK_CCL_Msk & (_UINT32_(value) << MCLK_APBDMASK_CCL_Pos)) /* Assignment of value for CCL in the MCLK_APBDMASK register */
...
#define MCLK_APBEMASK_RESETVALUE              _UINT32_(0x09)                                       /*  (MCLK_APBEMASK) APBE Mask  Reset Value */
...
#define MCLK_APBEMASK_PAC(value)              (MCLK_APBEMASK_PAC_Msk & (_UINT32_(value) << MCLK_APBEMASK_PAC_Pos)) /* Assignment of value for PAC in the MCLK_APBEMASK register */
