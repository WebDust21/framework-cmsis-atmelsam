...
#define PM_PLCFG_PLSEL(value)                 (PM_PLCFG_PLSEL_Msk & (_UINT8_(value) << PM_PLCFG_PLSEL_Pos)) /* Assignment of value for PLSEL in the PM_PLCFG register */
...
#define PM_PLCFG_Msk                          _UINT8_(0x03)                                        /* (PM_PLCFG) Register Mask  */
...
#define PM_INTENCLR_PLRDY(value)              (PM_INTENCLR_PLRDY_Msk & (_UINT8_(value) << PM_INTENCLR_PLRDY_Pos)) /* Assignment of value for PLRDY in the PM_INTENCLR register */
...
#define PM_INTENSET_PLRDY(value)              (PM_INTENSET_PLRDY_Msk & (_UINT8_(value) << PM_INTENSET_PLRDY_Pos)) /* Assignment of value for PLRDY in the PM_INTENSET register */
...
#define PM_INTFLAG_PLRDY(value)               (PM_INTFLAG_PLRDY_Msk & (_UINT8_(value) << PM_INTFLAG_PLRDY_Pos)) /* Assignment of value for PLRDY in the PM_INTFLAG register */
...
#define PM_STDBYCFG_PDCFG(value)              (PM_STDBYCFG_PDCFG_Msk & (_UINT16_(value) << PM_STDBYCFG_PDCFG_Pos)) /* Assignment of value for PDCFG in the PM_STDBYCFG register */
...
#define PM_STDBYCFG_DPGPD0(value)             (PM_STDBYCFG_DPGPD0_Msk & (_UINT16_(value) << PM_STDBYCFG_DPGPD0_Pos)) /* Assignment of value for DPGPD0 in the PM_STDBYCFG register */
...
#define PM_STDBYCFG_DPGPD1(value)             (PM_STDBYCFG_DPGPD1_Msk & (_UINT16_(value) << PM_STDBYCFG_DPGPD1_Pos)) /* Assignment of value for DPGPD1 in the PM_STDBYCFG register */
#define PM_STDBYCFG_AVREGSD_Pos               _UINT16_(7)                                          /* (PM_STDBYCFG) Automatic VREG Switching Disable Position */
#define PM_STDBYCFG_AVREGSD_Msk               (_UINT16_(0x1) << PM_STDBYCFG_AVREGSD_Pos)           /* (PM_STDBYCFG) Automatic VREG Switching Disable Mask */
#define PM_STDBYCFG_AVREGSD(value)            (PM_STDBYCFG_AVREGSD_Msk & (_UINT16_(value) << PM_STDBYCFG_AVREGSD_Pos)) /* Assignment of value for AVREGSD in the PM_STDBYCFG register */
...
#define PM_STDBYCFG_LINKPD(value)             (PM_STDBYCFG_LINKPD_Msk & (_UINT16_(value) << PM_STDBYCFG_LINKPD_Pos)) /* Assignment of value for LINKPD in the PM_STDBYCFG register */
...
#define PM_STDBYCFG_BBIASLP(value)            (PM_STDBYCFG_BBIASLP_Msk & (_UINT16_(value) << PM_STDBYCFG_BBIASLP_Pos)) /* Assignment of value for BBIASLP in the PM_STDBYCFG register */
...
#define PM_STDBYCFG_BBIASPP(value)            (PM_STDBYCFG_BBIASPP_Msk & (_UINT16_(value) << PM_STDBYCFG_BBIASPP_Pos)) /* Assignment of value for BBIASPP in the PM_STDBYCFG register */
#define PM_STDBYCFG_Msk                       _UINT16_(0xFFB3)                                     /* (PM_STDBYCFG) Register Mask  */
