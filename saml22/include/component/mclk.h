...
#define MCLK_APBCMASK_ADC(value)              (MCLK_APBCMASK_ADC_Msk & (_UINT32_(value) << MCLK_APBCMASK_ADC_Pos)) /* Assignment of value for ADC in the MCLK_APBCMASK register */
...
#define MCLK_APBCMASK_SLCD(value)             (MCLK_APBCMASK_SLCD_Msk & (_UINT32_(value) << MCLK_APBCMASK_SLCD_Pos)) /* Assignment of value for SLCD in the MCLK_APBCMASK register */
