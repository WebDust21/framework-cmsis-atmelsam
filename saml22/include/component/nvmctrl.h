...
#define NVMCTRL_CTRLB_FWUP(value)             (NVMCTRL_CTRLB_FWUP_Msk & (_UINT32_(value) << NVMCTRL_CTRLB_FWUP_Pos)) /* Assignment of value for FWUP in the NVMCTRL_CTRLB register */
