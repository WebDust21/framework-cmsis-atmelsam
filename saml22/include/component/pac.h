...
#define PAC_INTFLAGAHB_HSRAMDMAC(value)       (PAC_INTFLAGAHB_HSRAMDMAC_Msk & (_UINT32_(value) << PAC_INTFLAGAHB_HSRAMDMAC_Pos)) /* Assignment of value for HSRAMDMAC in the PAC_INTFLAGAHB register */
...
#define PAC_INTFLAGC_ADC(value)               (PAC_INTFLAGC_ADC_Msk & (_UINT32_(value) << PAC_INTFLAGC_ADC_Pos)) /* Assignment of value for ADC in the PAC_INTFLAGC register */
...
#define PAC_INTFLAGC_SLCD(value)              (PAC_INTFLAGC_SLCD_Msk & (_UINT32_(value) << PAC_INTFLAGC_SLCD_Pos)) /* Assignment of value for SLCD in the PAC_INTFLAGC register */
...
#define PAC_STATUSC_ADC(value)                (PAC_STATUSC_ADC_Msk & (_UINT32_(value) << PAC_STATUSC_ADC_Pos)) /* Assignment of value for ADC in the PAC_STATUSC register */
...
#define PAC_STATUSC_SLCD(value)               (PAC_STATUSC_SLCD_Msk & (_UINT32_(value) << PAC_STATUSC_SLCD_Pos)) /* Assignment of value for SLCD in the PAC_STATUSC register */
