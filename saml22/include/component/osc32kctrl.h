...
#define OSC32KCTRL_SLCDCTRL_SLCDSEL(value)    (OSC32KCTRL_SLCDCTRL_SLCDSEL_Msk & (_UINT8_(value) << OSC32KCTRL_SLCDCTRL_SLCDSEL_Pos)) /* Assignment of value for SLCDSEL in the OSC32KCTRL_SLCDCTRL register */
