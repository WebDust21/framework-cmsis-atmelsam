...
#define MATRIX_PRBS_Msk                       _UINT32_(0x00030003)                                 /* (MATRIX_PRBS) Register Mask  */
...
#define MATRIX_MRCR_Msk                       _UINT32_(0x0000117F)                                 /* (MATRIX_MRCR) Register Mask  */

#define MATRIX_MRCR_RCB_Pos                   _UINT32_(0)                                          /* (MATRIX_MRCR Position) Remap Command Bit for Master x2 */
#define MATRIX_MRCR_RCB_Msk                   (_UINT32_(0x1FF) << MATRIX_MRCR_RCB_Pos)             /* (MATRIX_MRCR Mask) RCB */
