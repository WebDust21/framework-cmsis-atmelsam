...
/*  file generated from device description file (ATDF) version 2025-06-24T07:32:10Z  */
...
#define SDADC_CTRLA_SWRST(value)              (SDADC_CTRLA_SWRST_Msk & (_UINT8_(value) << SDADC_CTRLA_SWRST_Pos)) /* Assignment of value for SWRST in the SDADC_CTRLA register */
...
#define SDADC_CTRLA_ENABLE(value)             (SDADC_CTRLA_ENABLE_Msk & (_UINT8_(value) << SDADC_CTRLA_ENABLE_Pos)) /* Assignment of value for ENABLE in the SDADC_CTRLA register */
...
#define SDADC_CTRLA_RUNSTDBY(value)           (SDADC_CTRLA_RUNSTDBY_Msk & (_UINT8_(value) << SDADC_CTRLA_RUNSTDBY_Pos)) /* Assignment of value for RUNSTDBY in the SDADC_CTRLA register */
...
#define SDADC_CTRLA_ONDEMAND(value)           (SDADC_CTRLA_ONDEMAND_Msk & (_UINT8_(value) << SDADC_CTRLA_ONDEMAND_Pos)) /* Assignment of value for ONDEMAND in the SDADC_CTRLA register */
...
#define SDADC_REFCTRL_REFSEL(value)           (SDADC_REFCTRL_REFSEL_Msk & (_UINT8_(value) << SDADC_REFCTRL_REFSEL_Pos)) /* Assignment of value for REFSEL in the SDADC_REFCTRL register */
...
#define SDADC_REFCTRL_REFRANGE(value)         (SDADC_REFCTRL_REFRANGE_Msk & (_UINT8_(value) << SDADC_REFCTRL_REFRANGE_Pos)) /* Assignment of value for REFRANGE in the SDADC_REFCTRL register */
...
#define SDADC_REFCTRL_ONREFBUF(value)         (SDADC_REFCTRL_ONREFBUF_Msk & (_UINT8_(value) << SDADC_REFCTRL_ONREFBUF_Pos)) /* Assignment of value for ONREFBUF in the SDADC_REFCTRL register */
...
#define SDADC_CTRLB_PRESCALER(value)          (SDADC_CTRLB_PRESCALER_Msk & (_UINT16_(value) << SDADC_CTRLB_PRESCALER_Pos)) /* Assignment of value for PRESCALER in the SDADC_CTRLB register */
...
#define SDADC_CTRLB_OSR(value)                (SDADC_CTRLB_OSR_Msk & (_UINT16_(value) << SDADC_CTRLB_OSR_Pos)) /* Assignment of value for OSR in the SDADC_CTRLB register */
...
#define SDADC_CTRLB_SKPCNT(value)             (SDADC_CTRLB_SKPCNT_Msk & (_UINT16_(value) << SDADC_CTRLB_SKPCNT_Pos)) /* Assignment of value for SKPCNT in the SDADC_CTRLB register */
...
#define SDADC_EVCTRL_FLUSHEI(value)           (SDADC_EVCTRL_FLUSHEI_Msk & (_UINT8_(value) << SDADC_EVCTRL_FLUSHEI_Pos)) /* Assignment of value for FLUSHEI in the SDADC_EVCTRL register */
...
#define SDADC_EVCTRL_STARTEI(value)           (SDADC_EVCTRL_STARTEI_Msk & (_UINT8_(value) << SDADC_EVCTRL_STARTEI_Pos)) /* Assignment of value for STARTEI in the SDADC_EVCTRL register */
...
#define SDADC_EVCTRL_FLUSHINV(value)          (SDADC_EVCTRL_FLUSHINV_Msk & (_UINT8_(value) << SDADC_EVCTRL_FLUSHINV_Pos)) /* Assignment of value for FLUSHINV in the SDADC_EVCTRL register */
...
#define SDADC_EVCTRL_STARTINV(value)          (SDADC_EVCTRL_STARTINV_Msk & (_UINT8_(value) << SDADC_EVCTRL_STARTINV_Pos)) /* Assignment of value for STARTINV in the SDADC_EVCTRL register */
...
#define SDADC_EVCTRL_RESRDYEO(value)          (SDADC_EVCTRL_RESRDYEO_Msk & (_UINT8_(value) << SDADC_EVCTRL_RESRDYEO_Pos)) /* Assignment of value for RESRDYEO in the SDADC_EVCTRL register */
...
#define SDADC_EVCTRL_WINMONEO(value)          (SDADC_EVCTRL_WINMONEO_Msk & (_UINT8_(value) << SDADC_EVCTRL_WINMONEO_Pos)) /* Assignment of value for WINMONEO in the SDADC_EVCTRL register */
...
#define SDADC_INTENCLR_RESRDY(value)          (SDADC_INTENCLR_RESRDY_Msk & (_UINT8_(value) << SDADC_INTENCLR_RESRDY_Pos)) /* Assignment of value for RESRDY in the SDADC_INTENCLR register */
...
#define SDADC_INTENCLR_OVERRUN(value)         (SDADC_INTENCLR_OVERRUN_Msk & (_UINT8_(value) << SDADC_INTENCLR_OVERRUN_Pos)) /* Assignment of value for OVERRUN in the SDADC_INTENCLR register */
...
#define SDADC_INTENCLR_WINMON(value)          (SDADC_INTENCLR_WINMON_Msk & (_UINT8_(value) << SDADC_INTENCLR_WINMON_Pos)) /* Assignment of value for WINMON in the SDADC_INTENCLR register */
...
#define SDADC_INTENSET_RESRDY(value)          (SDADC_INTENSET_RESRDY_Msk & (_UINT8_(value) << SDADC_INTENSET_RESRDY_Pos)) /* Assignment of value for RESRDY in the SDADC_INTENSET register */
...
#define SDADC_INTENSET_OVERRUN(value)         (SDADC_INTENSET_OVERRUN_Msk & (_UINT8_(value) << SDADC_INTENSET_OVERRUN_Pos)) /* Assignment of value for OVERRUN in the SDADC_INTENSET register */
...
#define SDADC_INTENSET_WINMON(value)          (SDADC_INTENSET_WINMON_Msk & (_UINT8_(value) << SDADC_INTENSET_WINMON_Pos)) /* Assignment of value for WINMON in the SDADC_INTENSET register */
...
#define SDADC_INTFLAG_RESRDY(value)           (SDADC_INTFLAG_RESRDY_Msk & (_UINT8_(value) << SDADC_INTFLAG_RESRDY_Pos)) /* Assignment of value for RESRDY in the SDADC_INTFLAG register */
...
#define SDADC_INTFLAG_OVERRUN(value)          (SDADC_INTFLAG_OVERRUN_Msk & (_UINT8_(value) << SDADC_INTFLAG_OVERRUN_Pos)) /* Assignment of value for OVERRUN in the SDADC_INTFLAG register */
...
#define SDADC_INTFLAG_WINMON(value)           (SDADC_INTFLAG_WINMON_Msk & (_UINT8_(value) << SDADC_INTFLAG_WINMON_Pos)) /* Assignment of value for WINMON in the SDADC_INTFLAG register */
...
#define SDADC_SEQSTATUS_SEQSTATE(value)       (SDADC_SEQSTATUS_SEQSTATE_Msk & (_UINT8_(value) << SDADC_SEQSTATUS_SEQSTATE_Pos)) /* Assignment of value for SEQSTATE in the SDADC_SEQSTATUS register */
...
#define SDADC_SEQSTATUS_SEQBUSY(value)        (SDADC_SEQSTATUS_SEQBUSY_Msk & (_UINT8_(value) << SDADC_SEQSTATUS_SEQBUSY_Pos)) /* Assignment of value for SEQBUSY in the SDADC_SEQSTATUS register */
...
#define SDADC_INPUTCTRL_MUXSEL(value)         (SDADC_INPUTCTRL_MUXSEL_Msk & (_UINT8_(value) << SDADC_INPUTCTRL_MUXSEL_Pos)) /* Assignment of value for MUXSEL in the SDADC_INPUTCTRL register */
...
#define SDADC_CTRLC_FREERUN(value)            (SDADC_CTRLC_FREERUN_Msk & (_UINT8_(value) << SDADC_CTRLC_FREERUN_Pos)) /* Assignment of value for FREERUN in the SDADC_CTRLC register */
...
#define SDADC_WINCTRL_WINMODE(value)          (SDADC_WINCTRL_WINMODE_Msk & (_UINT8_(value) << SDADC_WINCTRL_WINMODE_Pos)) /* Assignment of value for WINMODE in the SDADC_WINCTRL register */
...
#define SDADC_WINLT_WINLT(value)              (SDADC_WINLT_WINLT_Msk & (_UINT32_(value) << SDADC_WINLT_WINLT_Pos)) /* Assignment of value for WINLT in the SDADC_WINLT register */
...
#define SDADC_WINUT_WINUT(value)              (SDADC_WINUT_WINUT_Msk & (_UINT32_(value) << SDADC_WINUT_WINUT_Pos)) /* Assignment of value for WINUT in the SDADC_WINUT register */
...
#define SDADC_OFFSETCORR_OFFSETCORR(value)    (SDADC_OFFSETCORR_OFFSETCORR_Msk & (_UINT32_(value) << SDADC_OFFSETCORR_OFFSETCORR_Pos)) /* Assignment of value for OFFSETCORR in the SDADC_OFFSETCORR register */
...
#define SDADC_GAINCORR_GAINCORR(value)        (SDADC_GAINCORR_GAINCORR_Msk & (_UINT16_(value) << SDADC_GAINCORR_GAINCORR_Pos)) /* Assignment of value for GAINCORR in the SDADC_GAINCORR register */
...
#define SDADC_SHIFTCORR_SHIFTCORR(value)      (SDADC_SHIFTCORR_SHIFTCORR_Msk & (_UINT8_(value) << SDADC_SHIFTCORR_SHIFTCORR_Pos)) /* Assignment of value for SHIFTCORR in the SDADC_SHIFTCORR register */
...
#define SDADC_SWTRIG_FLUSH(value)             (SDADC_SWTRIG_FLUSH_Msk & (_UINT8_(value) << SDADC_SWTRIG_FLUSH_Pos)) /* Assignment of value for FLUSH in the SDADC_SWTRIG register */
...
#define SDADC_SWTRIG_START(value)             (SDADC_SWTRIG_START_Msk & (_UINT8_(value) << SDADC_SWTRIG_START_Pos)) /* Assignment of value for START in the SDADC_SWTRIG register */
...
#define SDADC_SYNCBUSY_SWRST(value)           (SDADC_SYNCBUSY_SWRST_Msk & (_UINT32_(value) << SDADC_SYNCBUSY_SWRST_Pos)) /* Assignment of value for SWRST in the SDADC_SYNCBUSY register */
...
#define SDADC_SYNCBUSY_ENABLE(value)          (SDADC_SYNCBUSY_ENABLE_Msk & (_UINT32_(value) << SDADC_SYNCBUSY_ENABLE_Pos)) /* Assignment of value for ENABLE in the SDADC_SYNCBUSY register */
...
#define SDADC_SYNCBUSY_CTRLC(value)           (SDADC_SYNCBUSY_CTRLC_Msk & (_UINT32_(value) << SDADC_SYNCBUSY_CTRLC_Pos)) /* Assignment of value for CTRLC in the SDADC_SYNCBUSY register */
...
#define SDADC_SYNCBUSY_INPUTCTRL(value)       (SDADC_SYNCBUSY_INPUTCTRL_Msk & (_UINT32_(value) << SDADC_SYNCBUSY_INPUTCTRL_Pos)) /* Assignment of value for INPUTCTRL in the SDADC_SYNCBUSY register */
...
#define SDADC_SYNCBUSY_WINCTRL(value)         (SDADC_SYNCBUSY_WINCTRL_Msk & (_UINT32_(value) << SDADC_SYNCBUSY_WINCTRL_Pos)) /* Assignment of value for WINCTRL in the SDADC_SYNCBUSY register */
...
#define SDADC_SYNCBUSY_WINLT(value)           (SDADC_SYNCBUSY_WINLT_Msk & (_UINT32_(value) << SDADC_SYNCBUSY_WINLT_Pos)) /* Assignment of value for WINLT in the SDADC_SYNCBUSY register */
...
#define SDADC_SYNCBUSY_WINUT(value)           (SDADC_SYNCBUSY_WINUT_Msk & (_UINT32_(value) << SDADC_SYNCBUSY_WINUT_Pos)) /* Assignment of value for WINUT in the SDADC_SYNCBUSY register */
...
#define SDADC_SYNCBUSY_OFFSETCORR(value)      (SDADC_SYNCBUSY_OFFSETCORR_Msk & (_UINT32_(value) << SDADC_SYNCBUSY_OFFSETCORR_Pos)) /* Assignment of value for OFFSETCORR in the SDADC_SYNCBUSY register */
...
#define SDADC_SYNCBUSY_GAINCORR(value)        (SDADC_SYNCBUSY_GAINCORR_Msk & (_UINT32_(value) << SDADC_SYNCBUSY_GAINCORR_Pos)) /* Assignment of value for GAINCORR in the SDADC_SYNCBUSY register */
...
#define SDADC_SYNCBUSY_SHIFTCORR(value)       (SDADC_SYNCBUSY_SHIFTCORR_Msk & (_UINT32_(value) << SDADC_SYNCBUSY_SHIFTCORR_Pos)) /* Assignment of value for SHIFTCORR in the SDADC_SYNCBUSY register */
...
#define SDADC_SYNCBUSY_SWTRIG(value)          (SDADC_SYNCBUSY_SWTRIG_Msk & (_UINT32_(value) << SDADC_SYNCBUSY_SWTRIG_Pos)) /* Assignment of value for SWTRIG in the SDADC_SYNCBUSY register */
...
#define SDADC_SYNCBUSY_ANACTRL(value)         (SDADC_SYNCBUSY_ANACTRL_Msk & (_UINT32_(value) << SDADC_SYNCBUSY_ANACTRL_Pos)) /* Assignment of value for ANACTRL in the SDADC_SYNCBUSY register */
...
#define SDADC_RESULT_RESULT(value)            (SDADC_RESULT_RESULT_Msk & (_UINT32_(value) << SDADC_RESULT_RESULT_Pos)) /* Assignment of value for RESULT in the SDADC_RESULT register */
...
#define SDADC_RESULT_RESERVED(value)          (SDADC_RESULT_RESERVED_Msk & (_UINT32_(value) << SDADC_RESULT_RESERVED_Pos)) /* Assignment of value for RESERVED in the SDADC_RESULT register */
...
#define SDADC_SEQCTRL_SEQEN(value)            (SDADC_SEQCTRL_SEQEN_Msk & (_UINT8_(value) << SDADC_SEQCTRL_SEQEN_Pos)) /* Assignment of value for SEQEN in the SDADC_SEQCTRL register */
...
#define SDADC_ANACTRL_CTRSDADC(value)         (SDADC_ANACTRL_CTRSDADC_Msk & (_UINT8_(value) << SDADC_ANACTRL_CTRSDADC_Pos)) /* Assignment of value for CTRSDADC in the SDADC_ANACTRL register */
...
#define SDADC_ANACTRL_ONCHOP(value)           (SDADC_ANACTRL_ONCHOP_Msk & (_UINT8_(value) << SDADC_ANACTRL_ONCHOP_Pos)) /* Assignment of value for ONCHOP in the SDADC_ANACTRL register */
...
#define SDADC_ANACTRL_BUFTEST(value)          (SDADC_ANACTRL_BUFTEST_Msk & (_UINT8_(value) << SDADC_ANACTRL_BUFTEST_Pos)) /* Assignment of value for BUFTEST in the SDADC_ANACTRL register */
...
#define SDADC_DBGCTRL_DBGRUN(value)           (SDADC_DBGCTRL_DBGRUN_Msk & (_UINT8_(value) << SDADC_DBGCTRL_DBGRUN_Pos)) /* Assignment of value for DBGRUN in the SDADC_DBGCTRL register */
#define SDADC_DBGCTRL_Msk                     _UINT8_(0x01)                                        /* (SDADC_DBGCTRL) Register Mask  */


/* SDADC register offsets definitions */
