...
#define PAC_INTFLAGA_TSENS(value)             (PAC_INTFLAGA_TSENS_Msk & (_UINT32_(value) << PAC_INTFLAGA_TSENS_Pos)) /* Assignment of value for TSENS in the PAC_INTFLAGA register */
...
#define PAC_INTFLAGC_SDADC(value)             (PAC_INTFLAGC_SDADC_Msk & (_UINT32_(value) << PAC_INTFLAGC_SDADC_Pos)) /* Assignment of value for SDADC in the PAC_INTFLAGC register */
...
#define PAC_STATUSA_TSENS(value)              (PAC_STATUSA_TSENS_Msk & (_UINT32_(value) << PAC_STATUSA_TSENS_Pos)) /* Assignment of value for TSENS in the PAC_STATUSA register */
...
#define PAC_STATUSC_SDADC(value)              (PAC_STATUSC_SDADC_Msk & (_UINT32_(value) << PAC_STATUSC_SDADC_Pos)) /* Assignment of value for SDADC in the PAC_STATUSC register */
