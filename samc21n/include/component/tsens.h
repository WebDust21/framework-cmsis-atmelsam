...
#define TSENS_CTRLA_SWRST(value)              (TSENS_CTRLA_SWRST_Msk & (_UINT8_(value) << TSENS_CTRLA_SWRST_Pos)) /* Assignment of value for SWRST in the TSENS_CTRLA register */
...
#define TSENS_CTRLA_ENABLE(value)             (TSENS_CTRLA_ENABLE_Msk & (_UINT8_(value) << TSENS_CTRLA_ENABLE_Pos)) /* Assignment of value for ENABLE in the TSENS_CTRLA register */
...
#define TSENS_CTRLA_RUNSTDBY(value)           (TSENS_CTRLA_RUNSTDBY_Msk & (_UINT8_(value) << TSENS_CTRLA_RUNSTDBY_Pos)) /* Assignment of value for RUNSTDBY in the TSENS_CTRLA register */
...
#define TSENS_CTRLB_START(value)              (TSENS_CTRLB_START_Msk & (_UINT8_(value) << TSENS_CTRLB_START_Pos)) /* Assignment of value for START in the TSENS_CTRLB register */
...
#define TSENS_CTRLC_WINMODE(value)            (TSENS_CTRLC_WINMODE_Msk & (_UINT8_(value) << TSENS_CTRLC_WINMODE_Pos)) /* Assignment of value for WINMODE in the TSENS_CTRLC register */
...
#define TSENS_CTRLC_FREERUN(value)            (TSENS_CTRLC_FREERUN_Msk & (_UINT8_(value) << TSENS_CTRLC_FREERUN_Pos)) /* Assignment of value for FREERUN in the TSENS_CTRLC register */
...
#define TSENS_EVCTRL_STARTEI(value)           (TSENS_EVCTRL_STARTEI_Msk & (_UINT8_(value) << TSENS_EVCTRL_STARTEI_Pos)) /* Assignment of value for STARTEI in the TSENS_EVCTRL register */
...
#define TSENS_EVCTRL_STARTINV(value)          (TSENS_EVCTRL_STARTINV_Msk & (_UINT8_(value) << TSENS_EVCTRL_STARTINV_Pos)) /* Assignment of value for STARTINV in the TSENS_EVCTRL register */
...
#define TSENS_EVCTRL_WINEO(value)             (TSENS_EVCTRL_WINEO_Msk & (_UINT8_(value) << TSENS_EVCTRL_WINEO_Pos)) /* Assignment of value for WINEO in the TSENS_EVCTRL register */
...
#define TSENS_INTENCLR_RESRDY(value)          (TSENS_INTENCLR_RESRDY_Msk & (_UINT8_(value) << TSENS_INTENCLR_RESRDY_Pos)) /* Assignment of value for RESRDY in the TSENS_INTENCLR register */
...
#define TSENS_INTENCLR_OVERRUN(value)         (TSENS_INTENCLR_OVERRUN_Msk & (_UINT8_(value) << TSENS_INTENCLR_OVERRUN_Pos)) /* Assignment of value for OVERRUN in the TSENS_INTENCLR register */
...
#define TSENS_INTENCLR_WINMON(value)          (TSENS_INTENCLR_WINMON_Msk & (_UINT8_(value) << TSENS_INTENCLR_WINMON_Pos)) /* Assignment of value for WINMON in the TSENS_INTENCLR register */
...
#define TSENS_INTENCLR_OVF(value)             (TSENS_INTENCLR_OVF_Msk & (_UINT8_(value) << TSENS_INTENCLR_OVF_Pos)) /* Assignment of value for OVF in the TSENS_INTENCLR register */
...
#define TSENS_INTENSET_RESRDY(value)          (TSENS_INTENSET_RESRDY_Msk & (_UINT8_(value) << TSENS_INTENSET_RESRDY_Pos)) /* Assignment of value for RESRDY in the TSENS_INTENSET register */
...
#define TSENS_INTENSET_OVERRUN(value)         (TSENS_INTENSET_OVERRUN_Msk & (_UINT8_(value) << TSENS_INTENSET_OVERRUN_Pos)) /* Assignment of value for OVERRUN in the TSENS_INTENSET register */
...
#define TSENS_INTENSET_WINMON(value)          (TSENS_INTENSET_WINMON_Msk & (_UINT8_(value) << TSENS_INTENSET_WINMON_Pos)) /* Assignment of value for WINMON in the TSENS_INTENSET register */
...
#define TSENS_INTENSET_OVF(value)             (TSENS_INTENSET_OVF_Msk & (_UINT8_(value) << TSENS_INTENSET_OVF_Pos)) /* Assignment of value for OVF in the TSENS_INTENSET register */
...
#define TSENS_INTFLAG_RESRDY(value)           (TSENS_INTFLAG_RESRDY_Msk & (_UINT8_(value) << TSENS_INTFLAG_RESRDY_Pos)) /* Assignment of value for RESRDY in the TSENS_INTFLAG register */
...
#define TSENS_INTFLAG_OVERRUN(value)          (TSENS_INTFLAG_OVERRUN_Msk & (_UINT8_(value) << TSENS_INTFLAG_OVERRUN_Pos)) /* Assignment of value for OVERRUN in the TSENS_INTFLAG register */
...
#define TSENS_INTFLAG_WINMON(value)           (TSENS_INTFLAG_WINMON_Msk & (_UINT8_(value) << TSENS_INTFLAG_WINMON_Pos)) /* Assignment of value for WINMON in the TSENS_INTFLAG register */
...
#define TSENS_INTFLAG_OVF(value)              (TSENS_INTFLAG_OVF_Msk & (_UINT8_(value) << TSENS_INTFLAG_OVF_Pos)) /* Assignment of value for OVF in the TSENS_INTFLAG register */
...
#define TSENS_STATUS_OVF(value)               (TSENS_STATUS_OVF_Msk & (_UINT8_(value) << TSENS_STATUS_OVF_Pos)) /* Assignment of value for OVF in the TSENS_STATUS register */
...
#define TSENS_SYNCBUSY_SWRST(value)           (TSENS_SYNCBUSY_SWRST_Msk & (_UINT32_(value) << TSENS_SYNCBUSY_SWRST_Pos)) /* Assignment of value for SWRST in the TSENS_SYNCBUSY register */
...
#define TSENS_SYNCBUSY_ENABLE(value)          (TSENS_SYNCBUSY_ENABLE_Msk & (_UINT32_(value) << TSENS_SYNCBUSY_ENABLE_Pos)) /* Assignment of value for ENABLE in the TSENS_SYNCBUSY register */
...
#define TSENS_VALUE_VALUE(value)              (TSENS_VALUE_VALUE_Msk & (_UINT32_(value) << TSENS_VALUE_VALUE_Pos)) /* Assignment of value for VALUE in the TSENS_VALUE register */
...
#define TSENS_WINLT_WINLT(value)              (TSENS_WINLT_WINLT_Msk & (_UINT32_(value) << TSENS_WINLT_WINLT_Pos)) /* Assignment of value for WINLT in the TSENS_WINLT register */
...
#define TSENS_WINUT_WINUT(value)              (TSENS_WINUT_WINUT_Msk & (_UINT32_(value) << TSENS_WINUT_WINUT_Pos)) /* Assignment of value for WINUT in the TSENS_WINUT register */
...
#define TSENS_GAIN_GAIN(value)                (TSENS_GAIN_GAIN_Msk & (_UINT32_(value) << TSENS_GAIN_GAIN_Pos)) /* Assignment of value for GAIN in the TSENS_GAIN register */
...
#define TSENS_OFFSET_OFFSETC(value)           (TSENS_OFFSET_OFFSETC_Msk & (_UINT32_(value) << TSENS_OFFSET_OFFSETC_Pos)) /* Assignment of value for OFFSETC in the TSENS_OFFSET register */
...
#define TSENS_CAL_FCAL(value)                 (TSENS_CAL_FCAL_Msk & (_UINT32_(value) << TSENS_CAL_FCAL_Pos)) /* Assignment of value for FCAL in the TSENS_CAL register */
...
#define TSENS_CAL_TCAL(value)                 (TSENS_CAL_TCAL_Msk & (_UINT32_(value) << TSENS_CAL_TCAL_Pos)) /* Assignment of value for TCAL in the TSENS_CAL register */
...
#define TSENS_DBGCTRL_DBGRUN(value)           (TSENS_DBGCTRL_DBGRUN_Msk & (_UINT8_(value) << TSENS_DBGCTRL_DBGRUN_Pos)) /* Assignment of value for DBGRUN in the TSENS_DBGCTRL register */
#define TSENS_DBGCTRL_Msk                     _UINT8_(0x01)                                        /* (TSENS_DBGCTRL) Register Mask  */


/* TSENS register offsets definitions */
