...
#define MCLK_APBAMASK_TSENS(value)            (MCLK_APBAMASK_TSENS_Msk & (_UINT32_(value) << MCLK_APBAMASK_TSENS_Pos)) /* Assignment of value for TSENS in the MCLK_APBAMASK register */
...
#define MCLK_APBCMASK_SDADC(value)            (MCLK_APBCMASK_SDADC_Msk & (_UINT32_(value) << MCLK_APBCMASK_SDADC_Pos)) /* Assignment of value for SDADC in the MCLK_APBCMASK register */
