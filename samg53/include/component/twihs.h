...
#define TWIHS_CR_Msk                          _UINT32_(0x350383FF)                                 /* (TWIHS_CR) Register Mask  */
...
#define TWIHS_SMR_Msk                         _UINT32_(0xF07F7F40)                                 /* (TWIHS_SMR) Register Mask  */
...
#define TWIHS_CWGR_Msk                        _UINT32_(0x1F07FFFF)                                 /* (TWIHS_CWGR) Register Mask  */
...
#define TWIHS_SR_ENDRX_Pos                    _UINT32_(12)                                         /* (TWIHS_SR) End of RX Buffer (cleared by writing TWIHS_RCR or TWIHS_RNCR) Position */
#define TWIHS_SR_ENDRX_Msk                    (_UINT32_(0x1) << TWIHS_SR_ENDRX_Pos)                /* (TWIHS_SR) End of RX Buffer (cleared by writing TWIHS_RCR or TWIHS_RNCR) Mask */
#define TWIHS_SR_ENDRX(value)                 (TWIHS_SR_ENDRX_Msk & (_UINT32_(value) << TWIHS_SR_ENDRX_Pos)) /* Assigment of value for ENDRX in the TWIHS_SR register */
#define TWIHS_SR_ENDTX_Pos                    _UINT32_(13)                                         /* (TWIHS_SR) End of TX Buffer (cleared by writing TWIHS_TCR or TWIHS_TNCR) Position */
#define TWIHS_SR_ENDTX_Msk                    (_UINT32_(0x1) << TWIHS_SR_ENDTX_Pos)                /* (TWIHS_SR) End of TX Buffer (cleared by writing TWIHS_TCR or TWIHS_TNCR) Mask */
#define TWIHS_SR_ENDTX(value)                 (TWIHS_SR_ENDTX_Msk & (_UINT32_(value) << TWIHS_SR_ENDTX_Pos)) /* Assigment of value for ENDTX in the TWIHS_SR register */
#define TWIHS_SR_RXBUFF_Pos                   _UINT32_(14)                                         /* (TWIHS_SR) RX Buffer Full (cleared by writing TWIHS_RCR or TWIHS_RNCR) Position */
#define TWIHS_SR_RXBUFF_Msk                   (_UINT32_(0x1) << TWIHS_SR_RXBUFF_Pos)               /* (TWIHS_SR) RX Buffer Full (cleared by writing TWIHS_RCR or TWIHS_RNCR) Mask */
#define TWIHS_SR_RXBUFF(value)                (TWIHS_SR_RXBUFF_Msk & (_UINT32_(value) << TWIHS_SR_RXBUFF_Pos)) /* Assigment of value for RXBUFF in the TWIHS_SR register */
#define TWIHS_SR_TXBUFE_Pos                   _UINT32_(15)                                         /* (TWIHS_SR) TX Buffer Empty (cleared by writing TWIHS_TCR or TWIHS_TNCR) Position */
#define TWIHS_SR_TXBUFE_Msk                   (_UINT32_(0x1) << TWIHS_SR_TXBUFE_Pos)               /* (TWIHS_SR) TX Buffer Empty (cleared by writing TWIHS_TCR or TWIHS_TNCR) Mask */
#define TWIHS_SR_TXBUFE(value)                (TWIHS_SR_TXBUFE_Msk & (_UINT32_(value) << TWIHS_SR_TXBUFE_Pos)) /* Assigment of value for TXBUFE in the TWIHS_SR register */
...
#define TWIHS_SR_Msk                          _UINT32_(0x0300FFFF)                                 /* (TWIHS_SR) Register Mask  */
...
#define TWIHS_IER_ENDRX_Pos                   _UINT32_(12)                                         /* (TWIHS_IER) End of Receive Buffer Interrupt Enable Position */
#define TWIHS_IER_ENDRX_Msk                   (_UINT32_(0x1) << TWIHS_IER_ENDRX_Pos)               /* (TWIHS_IER) End of Receive Buffer Interrupt Enable Mask */
#define TWIHS_IER_ENDRX(value)                (TWIHS_IER_ENDRX_Msk & (_UINT32_(value) << TWIHS_IER_ENDRX_Pos)) /* Assigment of value for ENDRX in the TWIHS_IER register */
#define TWIHS_IER_ENDTX_Pos                   _UINT32_(13)                                         /* (TWIHS_IER) End of Transmit Buffer Interrupt Enable Position */
#define TWIHS_IER_ENDTX_Msk                   (_UINT32_(0x1) << TWIHS_IER_ENDTX_Pos)               /* (TWIHS_IER) End of Transmit Buffer Interrupt Enable Mask */
#define TWIHS_IER_ENDTX(value)                (TWIHS_IER_ENDTX_Msk & (_UINT32_(value) << TWIHS_IER_ENDTX_Pos)) /* Assigment of value for ENDTX in the TWIHS_IER register */
#define TWIHS_IER_RXBUFF_Pos                  _UINT32_(14)                                         /* (TWIHS_IER) Receive Buffer Full Interrupt Enable Position */
#define TWIHS_IER_RXBUFF_Msk                  (_UINT32_(0x1) << TWIHS_IER_RXBUFF_Pos)              /* (TWIHS_IER) Receive Buffer Full Interrupt Enable Mask */
#define TWIHS_IER_RXBUFF(value)               (TWIHS_IER_RXBUFF_Msk & (_UINT32_(value) << TWIHS_IER_RXBUFF_Pos)) /* Assigment of value for RXBUFF in the TWIHS_IER register */
#define TWIHS_IER_TXBUFE_Pos                  _UINT32_(15)                                         /* (TWIHS_IER) Transmit Buffer Empty Interrupt Enable Position */
#define TWIHS_IER_TXBUFE_Msk                  (_UINT32_(0x1) << TWIHS_IER_TXBUFE_Pos)              /* (TWIHS_IER) Transmit Buffer Empty Interrupt Enable Mask */
#define TWIHS_IER_TXBUFE(value)               (TWIHS_IER_TXBUFE_Msk & (_UINT32_(value) << TWIHS_IER_TXBUFE_Pos)) /* Assigment of value for TXBUFE in the TWIHS_IER register */
#define TWIHS_IER_Msk                         _UINT32_(0x0000FFF7)                                 /* (TWIHS_IER) Register Mask  */
...
#define TWIHS_IDR_ENDRX_Pos                   _UINT32_(12)                                         /* (TWIHS_IDR) End of Receive Buffer Interrupt Disable Position */
#define TWIHS_IDR_ENDRX_Msk                   (_UINT32_(0x1) << TWIHS_IDR_ENDRX_Pos)               /* (TWIHS_IDR) End of Receive Buffer Interrupt Disable Mask */
#define TWIHS_IDR_ENDRX(value)                (TWIHS_IDR_ENDRX_Msk & (_UINT32_(value) << TWIHS_IDR_ENDRX_Pos)) /* Assigment of value for ENDRX in the TWIHS_IDR register */
#define TWIHS_IDR_ENDTX_Pos                   _UINT32_(13)                                         /* (TWIHS_IDR) End of Transmit Buffer Interrupt Disable Position */
#define TWIHS_IDR_ENDTX_Msk                   (_UINT32_(0x1) << TWIHS_IDR_ENDTX_Pos)               /* (TWIHS_IDR) End of Transmit Buffer Interrupt Disable Mask */
#define TWIHS_IDR_ENDTX(value)                (TWIHS_IDR_ENDTX_Msk & (_UINT32_(value) << TWIHS_IDR_ENDTX_Pos)) /* Assigment of value for ENDTX in the TWIHS_IDR register */
#define TWIHS_IDR_RXBUFF_Pos                  _UINT32_(14)                                         /* (TWIHS_IDR) Receive Buffer Full Interrupt Disable Position */
#define TWIHS_IDR_RXBUFF_Msk                  (_UINT32_(0x1) << TWIHS_IDR_RXBUFF_Pos)              /* (TWIHS_IDR) Receive Buffer Full Interrupt Disable Mask */
#define TWIHS_IDR_RXBUFF(value)               (TWIHS_IDR_RXBUFF_Msk & (_UINT32_(value) << TWIHS_IDR_RXBUFF_Pos)) /* Assigment of value for RXBUFF in the TWIHS_IDR register */
#define TWIHS_IDR_TXBUFE_Pos                  _UINT32_(15)                                         /* (TWIHS_IDR) Transmit Buffer Empty Interrupt Disable Position */
#define TWIHS_IDR_TXBUFE_Msk                  (_UINT32_(0x1) << TWIHS_IDR_TXBUFE_Pos)              /* (TWIHS_IDR) Transmit Buffer Empty Interrupt Disable Mask */
#define TWIHS_IDR_TXBUFE(value)               (TWIHS_IDR_TXBUFE_Msk & (_UINT32_(value) << TWIHS_IDR_TXBUFE_Pos)) /* Assigment of value for TXBUFE in the TWIHS_IDR register */
#define TWIHS_IDR_Msk                         _UINT32_(0x0000FFF7)                                 /* (TWIHS_IDR) Register Mask  */
...
#define TWIHS_IMR_ENDRX_Pos                   _UINT32_(12)                                         /* (TWIHS_IMR) End of Receive Buffer Interrupt Mask Position */
#define TWIHS_IMR_ENDRX_Msk                   (_UINT32_(0x1) << TWIHS_IMR_ENDRX_Pos)               /* (TWIHS_IMR) End of Receive Buffer Interrupt Mask Mask */
#define TWIHS_IMR_ENDRX(value)                (TWIHS_IMR_ENDRX_Msk & (_UINT32_(value) << TWIHS_IMR_ENDRX_Pos)) /* Assigment of value for ENDRX in the TWIHS_IMR register */
#define TWIHS_IMR_ENDTX_Pos                   _UINT32_(13)                                         /* (TWIHS_IMR) End of Transmit Buffer Interrupt Mask Position */
#define TWIHS_IMR_ENDTX_Msk                   (_UINT32_(0x1) << TWIHS_IMR_ENDTX_Pos)               /* (TWIHS_IMR) End of Transmit Buffer Interrupt Mask Mask */
#define TWIHS_IMR_ENDTX(value)                (TWIHS_IMR_ENDTX_Msk & (_UINT32_(value) << TWIHS_IMR_ENDTX_Pos)) /* Assigment of value for ENDTX in the TWIHS_IMR register */
#define TWIHS_IMR_RXBUFF_Pos                  _UINT32_(14)                                         /* (TWIHS_IMR) Receive Buffer Full Interrupt Mask Position */
#define TWIHS_IMR_RXBUFF_Msk                  (_UINT32_(0x1) << TWIHS_IMR_RXBUFF_Pos)              /* (TWIHS_IMR) Receive Buffer Full Interrupt Mask Mask */
#define TWIHS_IMR_RXBUFF(value)               (TWIHS_IMR_RXBUFF_Msk & (_UINT32_(value) << TWIHS_IMR_RXBUFF_Pos)) /* Assigment of value for RXBUFF in the TWIHS_IMR register */
#define TWIHS_IMR_TXBUFE_Pos                  _UINT32_(15)                                         /* (TWIHS_IMR) Transmit Buffer Empty Interrupt Mask Position */
#define TWIHS_IMR_TXBUFE_Msk                  (_UINT32_(0x1) << TWIHS_IMR_TXBUFE_Pos)              /* (TWIHS_IMR) Transmit Buffer Empty Interrupt Mask Mask */
#define TWIHS_IMR_TXBUFE(value)               (TWIHS_IMR_TXBUFE_Msk & (_UINT32_(value) << TWIHS_IMR_TXBUFE_Pos)) /* Assigment of value for TXBUFE in the TWIHS_IMR register */
#define TWIHS_IMR_Msk                         _UINT32_(0x0000FFF7)                                 /* (TWIHS_IMR) Register Mask  */
...
#define TWIHS_RPR_RXPTR_Pos                   _UINT32_(0)                                          /* (TWIHS_RPR) Receive Pointer Register Position */
#define TWIHS_RPR_RXPTR_Msk                   (_UINT32_(0xFFFFFFFF) << TWIHS_RPR_RXPTR_Pos)        /* (TWIHS_RPR) Receive Pointer Register Mask */
#define TWIHS_RPR_RXPTR(value)                (TWIHS_RPR_RXPTR_Msk & (_UINT32_(value) << TWIHS_RPR_RXPTR_Pos)) /* Assigment of value for RXPTR in the TWIHS_RPR register */
#define TWIHS_RPR_Msk                         _UINT32_(0xFFFFFFFF)                                 /* (TWIHS_RPR) Register Mask  */


/* -------- TWIHS_RCR : (TWIHS Offset: 0x104) (R/W 32) Receive Counter Register -------- */
#define TWIHS_RCR_RXCTR_Pos                   _UINT32_(0)                                          /* (TWIHS_RCR) Receive Counter Register Position */
#define TWIHS_RCR_RXCTR_Msk                   (_UINT32_(0xFFFF) << TWIHS_RCR_RXCTR_Pos)            /* (TWIHS_RCR) Receive Counter Register Mask */
#define TWIHS_RCR_RXCTR(value)                (TWIHS_RCR_RXCTR_Msk & (_UINT32_(value) << TWIHS_RCR_RXCTR_Pos)) /* Assigment of value for RXCTR in the TWIHS_RCR register */
#define TWIHS_RCR_Msk                         _UINT32_(0x0000FFFF)                                 /* (TWIHS_RCR) Register Mask  */


/* -------- TWIHS_TPR : (TWIHS Offset: 0x108) (R/W 32) Transmit Pointer Register -------- */
#define TWIHS_TPR_TXPTR_Pos                   _UINT32_(0)                                          /* (TWIHS_TPR) Transmit Counter Register Position */
#define TWIHS_TPR_TXPTR_Msk                   (_UINT32_(0xFFFFFFFF) << TWIHS_TPR_TXPTR_Pos)        /* (TWIHS_TPR) Transmit Counter Register Mask */
#define TWIHS_TPR_TXPTR(value)                (TWIHS_TPR_TXPTR_Msk & (_UINT32_(value) << TWIHS_TPR_TXPTR_Pos)) /* Assigment of value for TXPTR in the TWIHS_TPR register */
#define TWIHS_TPR_Msk                         _UINT32_(0xFFFFFFFF)                                 /* (TWIHS_TPR) Register Mask  */


/* -------- TWIHS_TCR : (TWIHS Offset: 0x10C) (R/W 32) Transmit Counter Register -------- */
#define TWIHS_TCR_TXCTR_Pos                   _UINT32_(0)                                          /* (TWIHS_TCR) Transmit Counter Register Position */
#define TWIHS_TCR_TXCTR_Msk                   (_UINT32_(0xFFFF) << TWIHS_TCR_TXCTR_Pos)            /* (TWIHS_TCR) Transmit Counter Register Mask */
#define TWIHS_TCR_TXCTR(value)                (TWIHS_TCR_TXCTR_Msk & (_UINT32_(value) << TWIHS_TCR_TXCTR_Pos)) /* Assigment of value for TXCTR in the TWIHS_TCR register */
#define TWIHS_TCR_Msk                         _UINT32_(0x0000FFFF)                                 /* (TWIHS_TCR) Register Mask  */


/* -------- TWIHS_RNPR : (TWIHS Offset: 0x110) (R/W 32) Receive Next Pointer Register -------- */
#define TWIHS_RNPR_RXNPTR_Pos                 _UINT32_(0)                                          /* (TWIHS_RNPR) Receive Next Pointer Position */
#define TWIHS_RNPR_RXNPTR_Msk                 (_UINT32_(0xFFFFFFFF) << TWIHS_RNPR_RXNPTR_Pos)      /* (TWIHS_RNPR) Receive Next Pointer Mask */
#define TWIHS_RNPR_RXNPTR(value)              (TWIHS_RNPR_RXNPTR_Msk & (_UINT32_(value) << TWIHS_RNPR_RXNPTR_Pos)) /* Assigment of value for RXNPTR in the TWIHS_RNPR register */
#define TWIHS_RNPR_Msk                        _UINT32_(0xFFFFFFFF)                                 /* (TWIHS_RNPR) Register Mask  */


/* -------- TWIHS_RNCR : (TWIHS Offset: 0x114) (R/W 32) Receive Next Counter Register -------- */
#define TWIHS_RNCR_RXNCTR_Pos                 _UINT32_(0)                                          /* (TWIHS_RNCR) Receive Next Counter Position */
#define TWIHS_RNCR_RXNCTR_Msk                 (_UINT32_(0xFFFF) << TWIHS_RNCR_RXNCTR_Pos)          /* (TWIHS_RNCR) Receive Next Counter Mask */
#define TWIHS_RNCR_RXNCTR(value)              (TWIHS_RNCR_RXNCTR_Msk & (_UINT32_(value) << TWIHS_RNCR_RXNCTR_Pos)) /* Assigment of value for RXNCTR in the TWIHS_RNCR register */
#define TWIHS_RNCR_Msk                        _UINT32_(0x0000FFFF)                                 /* (TWIHS_RNCR) Register Mask  */


/* -------- TWIHS_TNPR : (TWIHS Offset: 0x118) (R/W 32) Transmit Next Pointer Register -------- */
#define TWIHS_TNPR_TXNPTR_Pos                 _UINT32_(0)                                          /* (TWIHS_TNPR) Transmit Next Pointer Position */
#define TWIHS_TNPR_TXNPTR_Msk                 (_UINT32_(0xFFFFFFFF) << TWIHS_TNPR_TXNPTR_Pos)      /* (TWIHS_TNPR) Transmit Next Pointer Mask */
#define TWIHS_TNPR_TXNPTR(value)              (TWIHS_TNPR_TXNPTR_Msk & (_UINT32_(value) << TWIHS_TNPR_TXNPTR_Pos)) /* Assigment of value for TXNPTR in the TWIHS_TNPR register */
#define TWIHS_TNPR_Msk                        _UINT32_(0xFFFFFFFF)                                 /* (TWIHS_TNPR) Register Mask  */


/* -------- TWIHS_TNCR : (TWIHS Offset: 0x11C) (R/W 32) Transmit Next Counter Register -------- */
#define TWIHS_TNCR_TXNCTR_Pos                 _UINT32_(0)                                          /* (TWIHS_TNCR) Transmit Counter Next Position */
#define TWIHS_TNCR_TXNCTR_Msk                 (_UINT32_(0xFFFF) << TWIHS_TNCR_TXNCTR_Pos)          /* (TWIHS_TNCR) Transmit Counter Next Mask */
#define TWIHS_TNCR_TXNCTR(value)              (TWIHS_TNCR_TXNCTR_Msk & (_UINT32_(value) << TWIHS_TNCR_TXNCTR_Pos)) /* Assigment of value for TXNCTR in the TWIHS_TNCR register */
#define TWIHS_TNCR_Msk                        _UINT32_(0x0000FFFF)                                 /* (TWIHS_TNCR) Register Mask  */


/* -------- TWIHS_PTCR : (TWIHS Offset: 0x120) ( /W 32) Transfer Control Register -------- */
#define TWIHS_PTCR_RXTEN_Pos                  _UINT32_(0)                                          /* (TWIHS_PTCR) Receiver Transfer Enable Position */
#define TWIHS_PTCR_RXTEN_Msk                  (_UINT32_(0x1) << TWIHS_PTCR_RXTEN_Pos)              /* (TWIHS_PTCR) Receiver Transfer Enable Mask */
#define TWIHS_PTCR_RXTEN(value)               (TWIHS_PTCR_RXTEN_Msk & (_UINT32_(value) << TWIHS_PTCR_RXTEN_Pos)) /* Assigment of value for RXTEN in the TWIHS_PTCR register */
#define TWIHS_PTCR_RXTDIS_Pos                 _UINT32_(1)                                          /* (TWIHS_PTCR) Receiver Transfer Disable Position */
#define TWIHS_PTCR_RXTDIS_Msk                 (_UINT32_(0x1) << TWIHS_PTCR_RXTDIS_Pos)             /* (TWIHS_PTCR) Receiver Transfer Disable Mask */
#define TWIHS_PTCR_RXTDIS(value)              (TWIHS_PTCR_RXTDIS_Msk & (_UINT32_(value) << TWIHS_PTCR_RXTDIS_Pos)) /* Assigment of value for RXTDIS in the TWIHS_PTCR register */
#define TWIHS_PTCR_TXTEN_Pos                  _UINT32_(8)                                          /* (TWIHS_PTCR) Transmitter Transfer Enable Position */
#define TWIHS_PTCR_TXTEN_Msk                  (_UINT32_(0x1) << TWIHS_PTCR_TXTEN_Pos)              /* (TWIHS_PTCR) Transmitter Transfer Enable Mask */
#define TWIHS_PTCR_TXTEN(value)               (TWIHS_PTCR_TXTEN_Msk & (_UINT32_(value) << TWIHS_PTCR_TXTEN_Pos)) /* Assigment of value for TXTEN in the TWIHS_PTCR register */
#define TWIHS_PTCR_TXTDIS_Pos                 _UINT32_(9)                                          /* (TWIHS_PTCR) Transmitter Transfer Disable Position */
#define TWIHS_PTCR_TXTDIS_Msk                 (_UINT32_(0x1) << TWIHS_PTCR_TXTDIS_Pos)             /* (TWIHS_PTCR) Transmitter Transfer Disable Mask */
#define TWIHS_PTCR_TXTDIS(value)              (TWIHS_PTCR_TXTDIS_Msk & (_UINT32_(value) << TWIHS_PTCR_TXTDIS_Pos)) /* Assigment of value for TXTDIS in the TWIHS_PTCR register */
#define TWIHS_PTCR_RXCBEN_Pos                 _UINT32_(16)                                         /* (TWIHS_PTCR) Receiver Circular Buffer Enable Position */
#define TWIHS_PTCR_RXCBEN_Msk                 (_UINT32_(0x1) << TWIHS_PTCR_RXCBEN_Pos)             /* (TWIHS_PTCR) Receiver Circular Buffer Enable Mask */
#define TWIHS_PTCR_RXCBEN(value)              (TWIHS_PTCR_RXCBEN_Msk & (_UINT32_(value) << TWIHS_PTCR_RXCBEN_Pos)) /* Assigment of value for RXCBEN in the TWIHS_PTCR register */
#define TWIHS_PTCR_RXCBDIS_Pos                _UINT32_(17)                                         /* (TWIHS_PTCR) Receiver Circular Buffer Disable Position */
#define TWIHS_PTCR_RXCBDIS_Msk                (_UINT32_(0x1) << TWIHS_PTCR_RXCBDIS_Pos)            /* (TWIHS_PTCR) Receiver Circular Buffer Disable Mask */
#define TWIHS_PTCR_RXCBDIS(value)             (TWIHS_PTCR_RXCBDIS_Msk & (_UINT32_(value) << TWIHS_PTCR_RXCBDIS_Pos)) /* Assigment of value for RXCBDIS in the TWIHS_PTCR register */
#define TWIHS_PTCR_TXCBEN_Pos                 _UINT32_(18)                                         /* (TWIHS_PTCR) Transmitter Circular Buffer Enable Position */
#define TWIHS_PTCR_TXCBEN_Msk                 (_UINT32_(0x1) << TWIHS_PTCR_TXCBEN_Pos)             /* (TWIHS_PTCR) Transmitter Circular Buffer Enable Mask */
#define TWIHS_PTCR_TXCBEN(value)              (TWIHS_PTCR_TXCBEN_Msk & (_UINT32_(value) << TWIHS_PTCR_TXCBEN_Pos)) /* Assigment of value for TXCBEN in the TWIHS_PTCR register */
#define TWIHS_PTCR_TXCBDIS_Pos                _UINT32_(19)                                         /* (TWIHS_PTCR) Transmitter Circular Buffer Disable Position */
#define TWIHS_PTCR_TXCBDIS_Msk                (_UINT32_(0x1) << TWIHS_PTCR_TXCBDIS_Pos)            /* (TWIHS_PTCR) Transmitter Circular Buffer Disable Mask */
#define TWIHS_PTCR_TXCBDIS(value)             (TWIHS_PTCR_TXCBDIS_Msk & (_UINT32_(value) << TWIHS_PTCR_TXCBDIS_Pos)) /* Assigment of value for TXCBDIS in the TWIHS_PTCR register */
#define TWIHS_PTCR_ERRCLR_Pos                 _UINT32_(24)                                         /* (TWIHS_PTCR) Transfer Bus Error Clear Position */
#define TWIHS_PTCR_ERRCLR_Msk                 (_UINT32_(0x1) << TWIHS_PTCR_ERRCLR_Pos)             /* (TWIHS_PTCR) Transfer Bus Error Clear Mask */
#define TWIHS_PTCR_ERRCLR(value)              (TWIHS_PTCR_ERRCLR_Msk & (_UINT32_(value) << TWIHS_PTCR_ERRCLR_Pos)) /* Assigment of value for ERRCLR in the TWIHS_PTCR register */
#define TWIHS_PTCR_Msk                        _UINT32_(0x010F0303)                                 /* (TWIHS_PTCR) Register Mask  */


/* -------- TWIHS_PTSR : (TWIHS Offset: 0x124) ( R/ 32) Transfer Status Register -------- */
#define TWIHS_PTSR_RXTEN_Pos                  _UINT32_(0)                                          /* (TWIHS_PTSR) Receiver Transfer Enable Position */
#define TWIHS_PTSR_RXTEN_Msk                  (_UINT32_(0x1) << TWIHS_PTSR_RXTEN_Pos)              /* (TWIHS_PTSR) Receiver Transfer Enable Mask */
#define TWIHS_PTSR_RXTEN(value)               (TWIHS_PTSR_RXTEN_Msk & (_UINT32_(value) << TWIHS_PTSR_RXTEN_Pos)) /* Assigment of value for RXTEN in the TWIHS_PTSR register */
#define TWIHS_PTSR_TXTEN_Pos                  _UINT32_(8)                                          /* (TWIHS_PTSR) Transmitter Transfer Enable Position */
#define TWIHS_PTSR_TXTEN_Msk                  (_UINT32_(0x1) << TWIHS_PTSR_TXTEN_Pos)              /* (TWIHS_PTSR) Transmitter Transfer Enable Mask */
#define TWIHS_PTSR_TXTEN(value)               (TWIHS_PTSR_TXTEN_Msk & (_UINT32_(value) << TWIHS_PTSR_TXTEN_Pos)) /* Assigment of value for TXTEN in the TWIHS_PTSR register */
#define TWIHS_PTSR_RXCBEN_Pos                 _UINT32_(16)                                         /* (TWIHS_PTSR) Receiver Circular Buffer Enable Position */
#define TWIHS_PTSR_RXCBEN_Msk                 (_UINT32_(0x1) << TWIHS_PTSR_RXCBEN_Pos)             /* (TWIHS_PTSR) Receiver Circular Buffer Enable Mask */
#define TWIHS_PTSR_RXCBEN(value)              (TWIHS_PTSR_RXCBEN_Msk & (_UINT32_(value) << TWIHS_PTSR_RXCBEN_Pos)) /* Assigment of value for RXCBEN in the TWIHS_PTSR register */
#define TWIHS_PTSR_TXCBEN_Pos                 _UINT32_(18)                                         /* (TWIHS_PTSR) Transmitter Circular Buffer Enable Position */
#define TWIHS_PTSR_TXCBEN_Msk                 (_UINT32_(0x1) << TWIHS_PTSR_TXCBEN_Pos)             /* (TWIHS_PTSR) Transmitter Circular Buffer Enable Mask */
#define TWIHS_PTSR_TXCBEN(value)              (TWIHS_PTSR_TXCBEN_Msk & (_UINT32_(value) << TWIHS_PTSR_TXCBEN_Pos)) /* Assigment of value for TXCBEN in the TWIHS_PTSR register */
#define TWIHS_PTSR_ERR_Pos                    _UINT32_(24)                                         /* (TWIHS_PTSR) Transfer Bus Error Position */
#define TWIHS_PTSR_ERR_Msk                    (_UINT32_(0x1) << TWIHS_PTSR_ERR_Pos)                /* (TWIHS_PTSR) Transfer Bus Error Mask */
#define TWIHS_PTSR_ERR(value)                 (TWIHS_PTSR_ERR_Msk & (_UINT32_(value) << TWIHS_PTSR_ERR_Pos)) /* Assigment of value for ERR in the TWIHS_PTSR register */
#define TWIHS_PTSR_Msk                        _UINT32_(0x01050101)                                 /* (TWIHS_PTSR) Register Mask  */
...
#define TWIHS_RPR_REG_OFST             _UINT32_(0x100)     /* (TWIHS_RPR) Receive Pointer Register Offset */
#define TWIHS_RCR_REG_OFST             _UINT32_(0x104)     /* (TWIHS_RCR) Receive Counter Register Offset */
#define TWIHS_TPR_REG_OFST             _UINT32_(0x108)     /* (TWIHS_TPR) Transmit Pointer Register Offset */
#define TWIHS_TCR_REG_OFST             _UINT32_(0x10C)     /* (TWIHS_TCR) Transmit Counter Register Offset */
#define TWIHS_RNPR_REG_OFST            _UINT32_(0x110)     /* (TWIHS_RNPR) Receive Next Pointer Register Offset */
#define TWIHS_RNCR_REG_OFST            _UINT32_(0x114)     /* (TWIHS_RNCR) Receive Next Counter Register Offset */
#define TWIHS_TNPR_REG_OFST            _UINT32_(0x118)     /* (TWIHS_TNPR) Transmit Next Pointer Register Offset */
#define TWIHS_TNCR_REG_OFST            _UINT32_(0x11C)     /* (TWIHS_TNCR) Transmit Next Counter Register Offset */
#define TWIHS_PTCR_REG_OFST            _UINT32_(0x120)     /* (TWIHS_PTCR) Transfer Control Register Offset */
#define TWIHS_PTSR_REG_OFST            _UINT32_(0x124)     /* (TWIHS_PTSR) Transfer Status Register Offset */
...
typedef struct
{
  ...
  __IO  uint32_t                       TWIHS_RPR;          /**< Offset: 0x100 (R/W  32) Receive Pointer Register */
  __IO  uint32_t                       TWIHS_RCR;          /**< Offset: 0x104 (R/W  32) Receive Counter Register */
  __IO  uint32_t                       TWIHS_TPR;          /**< Offset: 0x108 (R/W  32) Transmit Pointer Register */
  __IO  uint32_t                       TWIHS_TCR;          /**< Offset: 0x10C (R/W  32) Transmit Counter Register */
  __IO  uint32_t                       TWIHS_RNPR;         /**< Offset: 0x110 (R/W  32) Receive Next Pointer Register */
  __IO  uint32_t                       TWIHS_RNCR;         /**< Offset: 0x114 (R/W  32) Receive Next Counter Register */
  __IO  uint32_t                       TWIHS_TNPR;         /**< Offset: 0x118 (R/W  32) Transmit Next Pointer Register */
  __IO  uint32_t                       TWIHS_TNCR;         /**< Offset: 0x11C (R/W  32) Transmit Next Counter Register */
  __O   uint32_t                       TWIHS_PTCR;         /**< Offset: 0x120 ( /W  32) Transfer Control Register */
  __I   uint32_t                       TWIHS_PTSR;         /**< Offset: 0x124 (R/   32) Transfer Status Register */
} twihs_registers_t;
