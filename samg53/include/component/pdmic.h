...
#define PDMIC_MR_Msk                          _UINT32_(0x00007F00)                                 /* (PDMIC_MR) Register Mask  */
...
#define PDMIC_DSPR_HPFBYP_Pos                 _UINT32_(1)                                          /* (PDMIC_DSPR) High-Pass Filter Bypass Position */
#define PDMIC_DSPR_HPFBYP_Msk                 (_UINT32_(0x1) << PDMIC_DSPR_HPFBYP_Pos)             /* (PDMIC_DSPR) High-Pass Filter Bypass Mask */
#define PDMIC_DSPR_HPFBYP(value)              (PDMIC_DSPR_HPFBYP_Msk & (_UINT32_(value) << PDMIC_DSPR_HPFBYP_Pos)) /* Assigment of value for HPFBYP in the PDMIC_DSPR register */
#define PDMIC_DSPR_SINBYP_Pos                 _UINT32_(2)                                          /* (PDMIC_DSPR) SINCC Filter Bypass Position */
#define PDMIC_DSPR_SINBYP_Msk                 (_UINT32_(0x1) << PDMIC_DSPR_SINBYP_Pos)             /* (PDMIC_DSPR) SINCC Filter Bypass Mask */
#define PDMIC_DSPR_SINBYP(value)              (PDMIC_DSPR_SINBYP_Msk & (_UINT32_(value) << PDMIC_DSPR_SINBYP_Pos)) /* Assigment of value for SINBYP in the PDMIC_DSPR register */
#define PDMIC_DSPR_SIZE_Pos                   _UINT32_(3)                                          /* (PDMIC_DSPR) Data Size Position */
#define PDMIC_DSPR_SIZE_Msk                   (_UINT32_(0x1) << PDMIC_DSPR_SIZE_Pos)               /* (PDMIC_DSPR) Data Size Mask */
#define PDMIC_DSPR_SIZE(value)                (PDMIC_DSPR_SIZE_Msk & (_UINT32_(value) << PDMIC_DSPR_SIZE_Pos)) /* Assigment of value for SIZE in the PDMIC_DSPR register */
#define PDMIC_DSPR_OSR_Pos                    _UINT32_(4)                                          /* (PDMIC_DSPR) Oversampling Ratio Position */
#define PDMIC_DSPR_OSR_Msk                    (_UINT32_(0x7) << PDMIC_DSPR_OSR_Pos)                /* (PDMIC_DSPR) Oversampling Ratio Mask */
#define PDMIC_DSPR_OSR(value)                 (PDMIC_DSPR_OSR_Msk & (_UINT32_(value) << PDMIC_DSPR_OSR_Pos)) /* Assigment of value for OSR in the PDMIC_DSPR register */
#define   PDMIC_DSPR_OSR_128_Val              _UINT32_(0x0)                                        /* (PDMIC_DSPR) Oversampling ratio is 128  */
#define   PDMIC_DSPR_OSR_64_Val               _UINT32_(0x1)                                        /* (PDMIC_DSPR) Oversampling ratio is 64  */
...
#define PDMIC_DSPR_SCALE_Pos                  _UINT32_(8)                                          /* (PDMIC_DSPR) Data Scale Position */
#define PDMIC_DSPR_SCALE_Msk                  (_UINT32_(0xF) << PDMIC_DSPR_SCALE_Pos)              /* (PDMIC_DSPR) Data Scale Mask */
#define PDMIC_DSPR_SCALE(value)               (PDMIC_DSPR_SCALE_Msk & (_UINT32_(value) << PDMIC_DSPR_SCALE_Pos)) /* Assigment of value for SCALE in the PDMIC_DSPR register */
#define PDMIC_DSPR_SHIFT_Pos                  _UINT32_(12)                                         /* (PDMIC_DSPR) Data Shift Position */
#define PDMIC_DSPR_SHIFT_Msk                  (_UINT32_(0xF) << PDMIC_DSPR_SHIFT_Pos)              /* (PDMIC_DSPR) Data Shift Mask */
#define PDMIC_DSPR_SHIFT(value)               (PDMIC_DSPR_SHIFT_Msk & (_UINT32_(value) << PDMIC_DSPR_SHIFT_Pos)) /* Assigment of value for SHIFT in the PDMIC_DSPR register */
#define PDMIC_DSPR_Msk                        _UINT32_(0x0000FF7E)                                 /* (PDMIC_DSPR) Register Mask  */
...
#define PDMIC_DSPR_REG_OFST            _UINT32_(0x58)      /* (PDMIC_DSPR) DSP Configuration Register 0 Offset */
#define PDMIC_DSPR0_REG_OFST           _UINT32_(0x58)      /* (PDMIC_DSPR0) DSP Configuration Register 0 Offset */
#define PDMIC_DSPR1_REG_OFST           _UINT32_(0x5C)      /* (PDMIC_DSPR1) DSP Configuration Register 0 Offset */
...
typedef struct
{
  ...
  __IO  uint32_t                       PDMIC_DSPR[2];      /**< Offset: 0x58 (R/W  32) DSP Configuration Register 0 */
