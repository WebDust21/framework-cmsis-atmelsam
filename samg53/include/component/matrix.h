...
#define   MATRIX_MCFG_ULBT_INFINITE_Val       _UINT32_(0x0)                                        /* (MATRIX_MCFG) No predicted end of burst is generated and therefore INCR bursts coming from this master cannot be broken.  */
...
#define   MATRIX_MCFG_ULBT_FOUR_BEAT_Val      _UINT32_(0x2)                                        /* (MATRIX_MCFG) The undefined length burst is split into a 4-beat bursts allowing rearbitration at each 4-beat burst end.  */
#define   MATRIX_MCFG_ULBT_EIGHT_BEAT_Val     _UINT32_(0x3)                                        /* (MATRIX_MCFG) The undefined length burst is split into 8-beat bursts allowing rearbitration at each 8-beat burst end.  */
#define   MATRIX_MCFG_ULBT_SIXTEEN_BEAT_Val   _UINT32_(0x4)                                        /* (MATRIX_MCFG) The undefined length burst is split into 16-beat bursts allowing rearbitration at each 16-beat burst end.  */
...
#define CCFG_SYSIO_Msk                        _UINT32_(0x000010F0)                                 /* (CCFG_SYSIO) Register Mask  */
