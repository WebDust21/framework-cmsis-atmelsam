...
/* ************************************************************************** */
/*   INSTANCE DEFINITIONS FOR SAMG51G18 */
/* ************************************************************************** */
...
/* ************************************************************************** */
/*   REGISTER STRUCTURE ADDRESS DEFINITIONS FOR SAMG51G18                     */
/* ************************************************************************** */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
...
#define IFLASH_SIZE                    _UINT32_(0x00040000)    /*  256kB Memory segment type: flash */
...
#define IRAM_SIZE                      _UINT32_(0x00010000)    /*   64kB Memory segment type: ram */
...
/* ************************************************************************** */
#define CHIP_JTAGID                    _UINT32_(0X05B3A03F)
#define CHIP_CIDR                      _UINT32_(0X243B09E0)
...
#define CHIP_FREQ_FWS_0                _UINT32_(15000000)  /* Maximum operating frequency when FWS is 0 */
#define CHIP_FREQ_FWS_1                _UINT32_(30000000)  /* Maximum operating frequency when FWS is 1 */
#define CHIP_FREQ_FWS_2                _UINT32_(45000000)  /* Maximum operating frequency when FWS is 2 */
#define CHIP_FREQ_FWS_3                _UINT32_(60000000)  /* Maximum operating frequency when FWS is 3 */
