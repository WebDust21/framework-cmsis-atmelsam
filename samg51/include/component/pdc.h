...
#define PDC_PERIPH_PTCR_Msk                   _UINT32_(0x00000303)                                 /* (PDC_PERIPH_PTCR) Register Mask  */
...
#define PDC_PERIPH_PTSR_Msk                   _UINT32_(0x00000101)                                 /* (PDC_PERIPH_PTSR) Register Mask  */
