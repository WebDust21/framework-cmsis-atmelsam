...
#define ADC_CR_AUTOCAL_Pos                    _UINT32_(3)                                          /* (ADC_CR) Automatic Calibration of ADC Position */
#define ADC_CR_AUTOCAL_Msk                    (_UINT32_(0x1) << ADC_CR_AUTOCAL_Pos)                /* (ADC_CR) Automatic Calibration of ADC Mask */
#define ADC_CR_AUTOCAL(value)                 (ADC_CR_AUTOCAL_Msk & (_UINT32_(value) << ADC_CR_AUTOCAL_Pos)) /* Assigment of value for AUTOCAL in the ADC_CR register */
#define ADC_CR_Msk                            _UINT32_(0x0000000B)                                 /* (ADC_CR) Register Mask  */
...
#define   ADC_MR_TRGSEL_ADC_TRIG0_Val         _UINT32_(0x0)                                        /* (ADC_MR) External trigger  */
#define   ADC_MR_TRGSEL_ADC_TRIG1_Val         _UINT32_(0x1)                                        /* (ADC_MR) TIO Output of the Timer Counter Channel 0  */
#define   ADC_MR_TRGSEL_ADC_TRIG2_Val         _UINT32_(0x2)                                        /* (ADC_MR) TIO Output of the Timer Counter Channel 1  */
#define   ADC_MR_TRGSEL_ADC_TRIG3_Val         _UINT32_(0x3)                                        /* (ADC_MR) TIO Output of the Timer Counter Channel 2  */
#define   ADC_MR_TRGSEL_ADC_TRIG4_Val         _UINT32_(0x4)                                        /* (ADC_MR) RTCOUT0  */
#define   ADC_MR_TRGSEL_ADC_TRIG5_Val         _UINT32_(0x5)                                        /* (ADC_MR) RTTINC  */
...
#define ADC_MR_LOWRES_Pos                     _UINT32_(4)                                          /* (ADC_MR) Resolution Position */
#define ADC_MR_LOWRES_Msk                     (_UINT32_(0x1) << ADC_MR_LOWRES_Pos)                 /* (ADC_MR) Resolution Mask */
...
#define   ADC_MR_LOWRES_BITS_10_Val           _UINT32_(0x0)                                        /* (ADC_MR) 10-bit resolution. For higher resolution by averaging, please refer to "ADC Extended Mode Register" on page 77.  */
#define   ADC_MR_LOWRES_BITS_8_Val            _UINT32_(0x1)                                        /* (ADC_MR) 8-bit resolution  */
...
#define   ADC_MR_SLEEP_SLEEP_Val              _UINT32_(0x1)                                        /* (ADC_MR) Sleep Mode: The ADC core and reference voltage circuitry are OFF between conversions.  */
...
#define ADC_MR_DIV1_Pos                       _UINT32_(22)                                         /* (ADC_MR) ADC Clock Prescaler Division forced to 1 Position */
#define ADC_MR_DIV1_Msk                       (_UINT32_(0x1) << ADC_MR_DIV1_Pos)                   /* (ADC_MR) ADC Clock Prescaler Division forced to 1 Mask */
#define ADC_MR_DIV1(value)                    (ADC_MR_DIV1_Msk & (_UINT32_(value) << ADC_MR_DIV1_Pos)) /* Assigment of value for DIV1 in the ADC_MR register */
#define   ADC_MR_DIV1_NO_DIV1_Val             _UINT32_(0x0)                                        /* (ADC_MR) The PRESCAL field is used to generate the ADC clock unless DIV3 is written to 1.  */
#define   ADC_MR_DIV1_FORCE_DIV1_Val          _UINT32_(0x1)                                        /* (ADC_MR) The ADC clock equals peripheral clock (PRESCAL and DIV3 fields have no effect).  */
...
#define ADC_MR_DIV3_Pos                       _UINT32_(30)                                         /* (ADC_MR) ADC Clock Prescaler Division forced to 3 Position */
#define ADC_MR_DIV3_Msk                       (_UINT32_(0x1) << ADC_MR_DIV3_Pos)                   /* (ADC_MR) ADC Clock Prescaler Division forced to 3 Mask */
#define ADC_MR_DIV3(value)                    (ADC_MR_DIV3_Msk & (_UINT32_(value) << ADC_MR_DIV3_Pos)) /* Assigment of value for DIV3 in the ADC_MR register */
#define   ADC_MR_DIV3_NO_DIV3_Val             _UINT32_(0x0)                                        /* (ADC_MR) The PRESCAL field is used to generate the ADC clock unless DIV1 is written to 1.  */
#define   ADC_MR_DIV3_FORCE_DIV3_Val          _UINT32_(0x1)                                        /* (ADC_MR) The ADC clock equals peripheral clock/3 unless DIV1 is written to 1.  */
...
#define ADC_MR_Msk                            _UINT32_(0xFF4FFFBF)                                 /* (ADC_MR) Register Mask  */
...
#define ADC_LCDR_LDATA_Msk                    (_UINT32_(0xFFF) << ADC_LCDR_LDATA_Pos)              /* (ADC_LCDR) Last Data Converted Mask */
...
#define ADC_LCDR_CHNB_Pos                     _UINT32_(12)                                         /* (ADC_LCDR) Channel Number Position */
#define ADC_LCDR_CHNB_Msk                     (_UINT32_(0xF) << ADC_LCDR_CHNB_Pos)                 /* (ADC_LCDR) Channel Number Mask */
#define ADC_LCDR_CHNB(value)                  (ADC_LCDR_CHNB_Msk & (_UINT32_(value) << ADC_LCDR_CHNB_Pos)) /* Assigment of value for CHNB in the ADC_LCDR register */
#define ADC_LCDR_Msk                          _UINT32_(0x0000FFFF)                                 /* (ADC_LCDR) Register Mask  */
...
#define ADC_IER_EOCAL_Pos                     _UINT32_(23)                                         /* (ADC_IER) End of Calibration Sequence Position */
#define ADC_IER_EOCAL_Msk                     (_UINT32_(0x1) << ADC_IER_EOCAL_Pos)                 /* (ADC_IER) End of Calibration Sequence Mask */
#define ADC_IER_EOCAL(value)                  (ADC_IER_EOCAL_Msk & (_UINT32_(value) << ADC_IER_EOCAL_Pos)) /* Assigment of value for EOCAL in the ADC_IER register */
...
#define ADC_IER_Msk                           _UINT32_(0x1F8800FF)                                 /* (ADC_IER) Register Mask  */
...
#define ADC_IDR_EOCAL_Pos                     _UINT32_(23)                                         /* (ADC_IDR) End of Calibration Sequence Position */
#define ADC_IDR_EOCAL_Msk                     (_UINT32_(0x1) << ADC_IDR_EOCAL_Pos)                 /* (ADC_IDR) End of Calibration Sequence Mask */
#define ADC_IDR_EOCAL(value)                  (ADC_IDR_EOCAL_Msk & (_UINT32_(value) << ADC_IDR_EOCAL_Pos)) /* Assigment of value for EOCAL in the ADC_IDR register */
...
#define ADC_IDR_Msk                           _UINT32_(0x1F8800FF)                                 /* (ADC_IDR) Register Mask  */
...
#define ADC_IMR_EOCAL_Pos                     _UINT32_(23)                                         /* (ADC_IMR) End of Calibration Sequence Position */
#define ADC_IMR_EOCAL_Msk                     (_UINT32_(0x1) << ADC_IMR_EOCAL_Pos)                 /* (ADC_IMR) End of Calibration Sequence Mask */
#define ADC_IMR_EOCAL(value)                  (ADC_IMR_EOCAL_Msk & (_UINT32_(value) << ADC_IMR_EOCAL_Pos)) /* Assigment of value for EOCAL in the ADC_IMR register */
...
#define ADC_IMR_Msk                           _UINT32_(0x1F8800FF)                                 /* (ADC_IMR) Register Mask  */
...
#define ADC_ISR_EOCAL_Pos                     _UINT32_(23)                                         /* (ADC_ISR) End of Calibration Sequence Position */
#define ADC_ISR_EOCAL_Msk                     (_UINT32_(0x1) << ADC_ISR_EOCAL_Pos)                 /* (ADC_ISR) End of Calibration Sequence Mask */
#define ADC_ISR_EOCAL(value)                  (ADC_ISR_EOCAL_Msk & (_UINT32_(value) << ADC_ISR_EOCAL_Pos)) /* Assigment of value for EOCAL in the ADC_ISR register */
...
#define ADC_ISR_Msk                           _UINT32_(0x1F8800FF)                                 /* (ADC_ISR) Register Mask  */
...
#define ADC_EMR_Msk                           _UINT32_(0x011332F3)                                 /* (ADC_EMR) Register Mask  */
...
#define ADC_CWR_LOWTHRES_Msk                  (_UINT32_(0xFFF) << ADC_CWR_LOWTHRES_Pos)            /* (ADC_CWR) Low Threshold Mask */
...
#define ADC_CWR_HIGHTHRES_Msk                 (_UINT32_(0xFFF) << ADC_CWR_HIGHTHRES_Pos)           /* (ADC_CWR) High Threshold Mask */
...
#define ADC_CWR_Msk                           _UINT32_(0x0FFF0FFF)                                 /* (ADC_CWR) Register Mask  */


/* -------- ADC_CDR : (ADC Offset: 0x50) ( R/ 32) Channel Data Register 0 -------- */
#define ADC_CDR_DATA_Pos                      _UINT32_(0)                                          /* (ADC_CDR) Converted Data Position */
#define ADC_CDR_DATA_Msk                      (_UINT32_(0xFFF) << ADC_CDR_DATA_Pos)                /* (ADC_CDR) Converted Data Mask */
...
#define ADC_CDR_Msk                           _UINT32_(0x00000FFF)                                 /* (ADC_CDR) Register Mask  */
...
#define ADC_PTCR_Msk                          _UINT32_(0x00000303)                                 /* (ADC_PTCR) Register Mask  */
...
#define ADC_PTSR_Msk                          _UINT32_(0x00000101)                                 /* (ADC_PTSR) Register Mask  */
