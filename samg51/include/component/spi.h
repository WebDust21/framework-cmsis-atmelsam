...
#define SPI_CR_Msk                            _UINT32_(0x01000083)                                 /* (SPI_CR) Register Mask  */
...
#define   SPI_MR_PCS_NPCS0_Val                _UINT32_(0x2)                                        /* (SPI_MR) NPCS0 as Chip Select  */
#define   SPI_MR_PCS_NPCS1_Val                _UINT32_(0x1)                                        /* (SPI_MR) NPCS1 as Chip Select  */
...
#define SPI_MR_Msk                            _UINT32_(0xFF0300B7)                                 /* (SPI_MR) Register Mask  */
...
#define   SPI_TDR_PCS_NPCS0_Val               _UINT32_(0x2)                                        /* (SPI_TDR) NPCS0 as Chip Select  */
#define   SPI_TDR_PCS_NPCS1_Val               _UINT32_(0x1)                                        /* (SPI_TDR) NPCS1 as Chip Select  */
...
#define SPI_SR_Msk                            _UINT32_(0x000107FF)                                 /* (SPI_SR) Register Mask  */
...
#define SPI_IER_Msk                           _UINT32_(0x000007FF)                                 /* (SPI_IER) Register Mask  */
...
#define SPI_IDR_Msk                           _UINT32_(0x000007FF)                                 /* (SPI_IDR) Register Mask  */
...
#define SPI_IMR_Msk                           _UINT32_(0x000007FF)                                 /* (SPI_IMR) Register Mask  */
...
#define   SPI_CSR_CPOL_IDLE_LOW_Val           _UINT32_(0x0)                                        /* (SPI_CSR) The inactive state value of SPCK is logic level zero  */
#define   SPI_CSR_CPOL_IDLE_HIGH_Val          _UINT32_(0x1)                                        /* (SPI_CSR) The inactive state value of SPCK is logic level one  */
#define SPI_CSR_CPOL_IDLE_LOW                 (SPI_CSR_CPOL_IDLE_LOW_Val << SPI_CSR_CPOL_Pos)      /* (SPI_CSR) The inactive state value of SPCK is logic level zero Position  */
#define SPI_CSR_CPOL_IDLE_HIGH                (SPI_CSR_CPOL_IDLE_HIGH_Val << SPI_CSR_CPOL_Pos)     /* (SPI_CSR) The inactive state value of SPCK is logic level one Position  */
...
#define SPI_CSR_SCBR_Pos                      _UINT32_(8)                                          /* (SPI_CSR) Serial Clock Baud Rate Position */
#define SPI_CSR_SCBR_Msk                      (_UINT32_(0xFF) << SPI_CSR_SCBR_Pos)                 /* (SPI_CSR) Serial Clock Baud Rate Mask */
...
#define SPI_PTCR_Msk                          _UINT32_(0x00000303)                                 /* (SPI_PTCR) Register Mask  */
...
#define SPI_PTSR_Msk                          _UINT32_(0x00000101)                                 /* (SPI_PTSR) Register Mask  */
...
#define SPI_CSR_REG_OFST               _UINT32_(0x30)      /* (SPI_CSR) Chip Select Register 0 Offset */
#define SPI_CSR0_REG_OFST              _UINT32_(0x30)      /* (SPI_CSR0) Chip Select Register 0 Offset */
#define SPI_CSR1_REG_OFST              _UINT32_(0x34)      /* (SPI_CSR1) Chip Select Register 0 Offset */
...
typedef struct
{
  ...
  __IO  uint32_t                       SPI_CSR[2];         /**< Offset: 0x30 (R/W  32) Chip Select Register 0 */
