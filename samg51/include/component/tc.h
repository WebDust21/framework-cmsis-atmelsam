...
#define   TC_CMR_TCCLKS_TIMER_CLOCK1_Val      _UINT32_(0x0)                                        /* (TC_CMR) Clock selected: internal TIMER_CLOCK1 clock signal (from PMC)  */
#define   TC_CMR_TCCLKS_TIMER_CLOCK2_Val      _UINT32_(0x1)                                        /* (TC_CMR) Clock selected: internal TIMER_CLOCK2 clock signal (from PMC)  */
#define   TC_CMR_TCCLKS_TIMER_CLOCK3_Val      _UINT32_(0x2)                                        /* (TC_CMR) Clock selected: internal TIMER_CLOCK3 clock signal (from PMC)  */
#define   TC_CMR_TCCLKS_TIMER_CLOCK4_Val      _UINT32_(0x3)                                        /* (TC_CMR) Clock selected: internal TIMER_CLOCK4 clock signal (from PMC)  */
#define   TC_CMR_TCCLKS_TIMER_CLOCK5_Val      _UINT32_(0x4)                                        /* (TC_CMR) Clock selected: internal TIMER_CLOCK5 clock signal (from PMC)  */
...
#define   TC_CMR_CAPTURE_LDRA_RISING_Val      _UINT32_(0x1)                                        /* (TC_CMR) Rising edge of TIOA  */
#define   TC_CMR_CAPTURE_LDRA_FALLING_Val     _UINT32_(0x2)                                        /* (TC_CMR) Falling edge of TIOA  */
#define   TC_CMR_CAPTURE_LDRA_EDGE_Val        _UINT32_(0x3)                                        /* (TC_CMR) Each edge of TIOA  */
#define TC_CMR_CAPTURE_LDRA_NONE              (TC_CMR_CAPTURE_LDRA_NONE_Val << TC_CMR_CAPTURE_LDRA_Pos) /* (TC_CMR) None Position  */
#define TC_CMR_CAPTURE_LDRA_RISING            (TC_CMR_CAPTURE_LDRA_RISING_Val << TC_CMR_CAPTURE_LDRA_Pos) /* (TC_CMR) Rising edge of TIOA Position  */
#define TC_CMR_CAPTURE_LDRA_FALLING           (TC_CMR_CAPTURE_LDRA_FALLING_Val << TC_CMR_CAPTURE_LDRA_Pos) /* (TC_CMR) Falling edge of TIOA Position  */
#define TC_CMR_CAPTURE_LDRA_EDGE              (TC_CMR_CAPTURE_LDRA_EDGE_Val << TC_CMR_CAPTURE_LDRA_Pos) /* (TC_CMR) Each edge of TIOA Position  */
...
#define   TC_CMR_CAPTURE_LDRB_RISING_Val      _UINT32_(0x1)                                        /* (TC_CMR) Rising edge of TIOA  */
#define   TC_CMR_CAPTURE_LDRB_FALLING_Val     _UINT32_(0x2)                                        /* (TC_CMR) Falling edge of TIOA  */
#define   TC_CMR_CAPTURE_LDRB_EDGE_Val        _UINT32_(0x3)                                        /* (TC_CMR) Each edge of TIOA  */
#define TC_CMR_CAPTURE_LDRB_NONE              (TC_CMR_CAPTURE_LDRB_NONE_Val << TC_CMR_CAPTURE_LDRB_Pos) /* (TC_CMR) None Position  */
#define TC_CMR_CAPTURE_LDRB_RISING            (TC_CMR_CAPTURE_LDRB_RISING_Val << TC_CMR_CAPTURE_LDRB_Pos) /* (TC_CMR) Rising edge of TIOA Position  */
#define TC_CMR_CAPTURE_LDRB_FALLING           (TC_CMR_CAPTURE_LDRB_FALLING_Val << TC_CMR_CAPTURE_LDRB_Pos) /* (TC_CMR) Falling edge of TIOA Position  */
#define TC_CMR_CAPTURE_LDRB_EDGE              (TC_CMR_CAPTURE_LDRB_EDGE_Val << TC_CMR_CAPTURE_LDRB_Pos) /* (TC_CMR) Each edge of TIOA Position  */
...
#define TC_SR_MTIOA_Pos                       _UINT32_(17)                                         /* (TC_SR) TIOA Mirror Position */
#define TC_SR_MTIOA_Msk                       (_UINT32_(0x1) << TC_SR_MTIOA_Pos)                   /* (TC_SR) TIOA Mirror Mask */
...
#define TC_SR_MTIOB_Pos                       _UINT32_(18)                                         /* (TC_SR) TIOB Mirror Position */
#define TC_SR_MTIOB_Msk                       (_UINT32_(0x1) << TC_SR_MTIOB_Pos)                   /* (TC_SR) TIOB Mirror Mask */
...
#define TC_SR_Msk                             _UINT32_(0x000703FF)                                 /* (TC_SR) Register Mask  */
...
#define TC_RPR2_RXPTR_Pos                     _UINT32_(0)                                          /* (TC_RPR2) Receive Pointer Register Position */
#define TC_RPR2_RXPTR_Msk                     (_UINT32_(0xFFFFFFFF) << TC_RPR2_RXPTR_Pos)          /* (TC_RPR2) Receive Pointer Register Mask */
#define TC_RPR2_RXPTR(value)                  (TC_RPR2_RXPTR_Msk & (_UINT32_(value) << TC_RPR2_RXPTR_Pos)) /* Assigment of value for RXPTR in the TC_RPR2 register */
#define TC_RPR2_Msk                           _UINT32_(0xFFFFFFFF)                                 /* (TC_RPR2) Register Mask  */


/* -------- TC_RNPR2 : (TC Offset: 0x190) (R/W 32) Receive Next Pointer Register (pdc = 2) -------- */
#define TC_RNPR2_RXNPTR_Pos                   _UINT32_(0)                                          /* (TC_RNPR2) Receive Next Pointer Position */
#define TC_RNPR2_RXNPTR_Msk                   (_UINT32_(0xFFFFFFFF) << TC_RNPR2_RXNPTR_Pos)        /* (TC_RNPR2) Receive Next Pointer Mask */
#define TC_RNPR2_RXNPTR(value)                (TC_RNPR2_RXNPTR_Msk & (_UINT32_(value) << TC_RNPR2_RXNPTR_Pos)) /* Assigment of value for RXNPTR in the TC_RNPR2 register */
#define TC_RNPR2_Msk                          _UINT32_(0xFFFFFFFF)                                 /* (TC_RNPR2) Register Mask  */


/* -------- TC_RNCR2 : (TC Offset: 0x194) (R/W 32) Receive Next Counter Register (pdc = 2) -------- */
#define TC_RNCR2_RXNCTR_Pos                   _UINT32_(0)                                          /* (TC_RNCR2) Receive Next Counter Position */
#define TC_RNCR2_RXNCTR_Msk                   (_UINT32_(0xFFFF) << TC_RNCR2_RXNCTR_Pos)            /* (TC_RNCR2) Receive Next Counter Mask */
#define TC_RNCR2_RXNCTR(value)                (TC_RNCR2_RXNCTR_Msk & (_UINT32_(value) << TC_RNCR2_RXNCTR_Pos)) /* Assigment of value for RXNCTR in the TC_RNCR2 register */
#define TC_RNCR2_Msk                          _UINT32_(0x0000FFFF)                                 /* (TC_RNCR2) Register Mask  */


/* -------- TC_PTCR2 : (TC Offset: 0x1A0) ( /W 32) Transfer Control Register (pdc = 2) -------- */
#define TC_PTCR2_RXTEN_Pos                    _UINT32_(0)                                          /* (TC_PTCR2) Receiver Transfer Enable Position */
#define TC_PTCR2_RXTEN_Msk                    (_UINT32_(0x1) << TC_PTCR2_RXTEN_Pos)                /* (TC_PTCR2) Receiver Transfer Enable Mask */
#define TC_PTCR2_RXTEN(value)                 (TC_PTCR2_RXTEN_Msk & (_UINT32_(value) << TC_PTCR2_RXTEN_Pos)) /* Assigment of value for RXTEN in the TC_PTCR2 register */
#define TC_PTCR2_RXTDIS_Pos                   _UINT32_(1)                                          /* (TC_PTCR2) Receiver Transfer Disable Position */
#define TC_PTCR2_RXTDIS_Msk                   (_UINT32_(0x1) << TC_PTCR2_RXTDIS_Pos)               /* (TC_PTCR2) Receiver Transfer Disable Mask */
#define TC_PTCR2_RXTDIS(value)                (TC_PTCR2_RXTDIS_Msk & (_UINT32_(value) << TC_PTCR2_RXTDIS_Pos)) /* Assigment of value for RXTDIS in the TC_PTCR2 register */
#define TC_PTCR2_TXTEN_Pos                    _UINT32_(8)                                          /* (TC_PTCR2) Transmitter Transfer Enable Position */
#define TC_PTCR2_TXTEN_Msk                    (_UINT32_(0x1) << TC_PTCR2_TXTEN_Pos)                /* (TC_PTCR2) Transmitter Transfer Enable Mask */
#define TC_PTCR2_TXTEN(value)                 (TC_PTCR2_TXTEN_Msk & (_UINT32_(value) << TC_PTCR2_TXTEN_Pos)) /* Assigment of value for TXTEN in the TC_PTCR2 register */
#define TC_PTCR2_TXTDIS_Pos                   _UINT32_(9)                                          /* (TC_PTCR2) Transmitter Transfer Disable Position */
#define TC_PTCR2_TXTDIS_Msk                   (_UINT32_(0x1) << TC_PTCR2_TXTDIS_Pos)               /* (TC_PTCR2) Transmitter Transfer Disable Mask */
#define TC_PTCR2_TXTDIS(value)                (TC_PTCR2_TXTDIS_Msk & (_UINT32_(value) << TC_PTCR2_TXTDIS_Pos)) /* Assigment of value for TXTDIS in the TC_PTCR2 register */
#define TC_PTCR2_Msk                          _UINT32_(0x00000303)                                 /* (TC_PTCR2) Register Mask  */


/* -------- TC_PTSR2 : (TC Offset: 0x1A4) ( R/ 32) Transfer Status Register (pdc = 2) -------- */
#define TC_PTSR2_RXTEN_Pos                    _UINT32_(0)                                          /* (TC_PTSR2) Receiver Transfer Enable Position */
#define TC_PTSR2_RXTEN_Msk                    (_UINT32_(0x1) << TC_PTSR2_RXTEN_Pos)                /* (TC_PTSR2) Receiver Transfer Enable Mask */
#define TC_PTSR2_RXTEN(value)                 (TC_PTSR2_RXTEN_Msk & (_UINT32_(value) << TC_PTSR2_RXTEN_Pos)) /* Assigment of value for RXTEN in the TC_PTSR2 register */
#define TC_PTSR2_TXTEN_Pos                    _UINT32_(8)                                          /* (TC_PTSR2) Transmitter Transfer Enable Position */
#define TC_PTSR2_TXTEN_Msk                    (_UINT32_(0x1) << TC_PTSR2_TXTEN_Pos)                /* (TC_PTSR2) Transmitter Transfer Enable Mask */
#define TC_PTSR2_TXTEN(value)                 (TC_PTSR2_TXTEN_Msk & (_UINT32_(value) << TC_PTSR2_TXTEN_Pos)) /* Assigment of value for TXTEN in the TC_PTSR2 register */
#define TC_PTSR2_Msk                          _UINT32_(0x00000101)                                 /* (TC_PTSR2) Register Mask  */
...
#define TC_RPR2_REG_OFST               _UINT32_(0x180)     /* (TC_RPR2) Receive Pointer Register (pdc = 2) Offset */
#define TC_RNPR2_REG_OFST              _UINT32_(0x190)     /* (TC_RNPR2) Receive Next Pointer Register (pdc = 2) Offset */
#define TC_RNCR2_REG_OFST              _UINT32_(0x194)     /* (TC_RNCR2) Receive Next Counter Register (pdc = 2) Offset */
#define TC_PTCR2_REG_OFST              _UINT32_(0x1A0)     /* (TC_PTCR2) Transfer Control Register (pdc = 2) Offset */
#define TC_PTSR2_REG_OFST              _UINT32_(0x1A4)     /* (TC_PTSR2) Transfer Status Register (pdc = 2) Offset */
...
typedef struct
{
  ...
  __IO  uint32_t                       TC_RPR2;            /**< Offset: 0x180 (R/W  32) Receive Pointer Register (pdc = 2) */
  __I   uint8_t                        Reserved3[0x0C];
  __IO  uint32_t                       TC_RNPR2;           /**< Offset: 0x190 (R/W  32) Receive Next Pointer Register (pdc = 2) */
  __IO  uint32_t                       TC_RNCR2;           /**< Offset: 0x194 (R/W  32) Receive Next Counter Register (pdc = 2) */
  __I   uint8_t                        Reserved4[0x08];
  __O   uint32_t                       TC_PTCR2;           /**< Offset: 0x1A0 ( /W  32) Transfer Control Register (pdc = 2) */
  __I   uint32_t                       TC_PTSR2;           /**< Offset: 0x1A4 (R/   32) Transfer Status Register (pdc = 2) */
} tc_registers_t;
