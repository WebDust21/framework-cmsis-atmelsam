...
#define CCFG_SMCNFCS_SDRAMEN(value)           (CCFG_SMCNFCS_SDRAMEN_Msk & (_UINT32_(value) << CCFG_SMCNFCS_SDRAMEN_Pos)) /* Assignment of value for SDRAMEN in the CCFG_SMCNFCS register */
