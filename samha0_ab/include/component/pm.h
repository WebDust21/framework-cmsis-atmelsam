...
#ifndef _SAMHA0_PM_COMPONENT_H_
#define _SAMHA0_PM_COMPONENT_H_
...
#define PM_APBCMASK_Msk                       _UINT32_(0x0107FFFF)                                 /* (PM_APBCMASK) Register Mask  */
