...
#ifndef _SAMHA0_DSU_COMPONENT_H_
#define _SAMHA0_DSU_COMPONENT_H_
...
#define DSU_DID_RESETVALUE                    _UINT32_(0x1001269C)                                 /*  (DSU_DID) Device Identification  Reset Value */
...
#endif /* _SAMHA0_DSU_COMPONENT_H_ */
