...
#define OPAMP_CTRLA_SWRST(value)              (OPAMP_CTRLA_SWRST_Msk & (_UINT8_(value) << OPAMP_CTRLA_SWRST_Pos)) /* Assignment of value for SWRST in the OPAMP_CTRLA register */
...
#define OPAMP_CTRLA_ENABLE(value)             (OPAMP_CTRLA_ENABLE_Msk & (_UINT8_(value) << OPAMP_CTRLA_ENABLE_Pos)) /* Assignment of value for ENABLE in the OPAMP_CTRLA register */
...
#define OPAMP_CTRLA_LPMUX(value)              (OPAMP_CTRLA_LPMUX_Msk & (_UINT8_(value) << OPAMP_CTRLA_LPMUX_Pos)) /* Assignment of value for LPMUX in the OPAMP_CTRLA register */
...
#define OPAMP_STATUS_READY0(value)            (OPAMP_STATUS_READY0_Msk & (_UINT8_(value) << OPAMP_STATUS_READY0_Pos)) /* Assignment of value for READY0 in the OPAMP_STATUS register */
...
#define OPAMP_STATUS_READY1(value)            (OPAMP_STATUS_READY1_Msk & (_UINT8_(value) << OPAMP_STATUS_READY1_Pos)) /* Assignment of value for READY1 in the OPAMP_STATUS register */
...
#define OPAMP_STATUS_READY2(value)            (OPAMP_STATUS_READY2_Msk & (_UINT8_(value) << OPAMP_STATUS_READY2_Pos)) /* Assignment of value for READY2 in the OPAMP_STATUS register */
...
#define OPAMP_OPAMPCTRL0_ENABLE(value)        (OPAMP_OPAMPCTRL0_ENABLE_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL0_ENABLE_Pos)) /* Assignment of value for ENABLE in the OPAMP_OPAMPCTRL0 register */
...
#define OPAMP_OPAMPCTRL0_ANAOUT(value)        (OPAMP_OPAMPCTRL0_ANAOUT_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL0_ANAOUT_Pos)) /* Assignment of value for ANAOUT in the OPAMP_OPAMPCTRL0 register */
...
#define OPAMP_OPAMPCTRL0_BIAS(value)          (OPAMP_OPAMPCTRL0_BIAS_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL0_BIAS_Pos)) /* Assignment of value for BIAS in the OPAMP_OPAMPCTRL0 register */
...
#define OPAMP_OPAMPCTRL0_RUNSTDBY(value)      (OPAMP_OPAMPCTRL0_RUNSTDBY_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL0_RUNSTDBY_Pos)) /* Assignment of value for RUNSTDBY in the OPAMP_OPAMPCTRL0 register */
...
#define OPAMP_OPAMPCTRL0_ONDEMAND(value)      (OPAMP_OPAMPCTRL0_ONDEMAND_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL0_ONDEMAND_Pos)) /* Assignment of value for ONDEMAND in the OPAMP_OPAMPCTRL0 register */
...
#define OPAMP_OPAMPCTRL0_RES2OUT(value)       (OPAMP_OPAMPCTRL0_RES2OUT_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL0_RES2OUT_Pos)) /* Assignment of value for RES2OUT in the OPAMP_OPAMPCTRL0 register */
...
#define OPAMP_OPAMPCTRL0_RES2VCC(value)       (OPAMP_OPAMPCTRL0_RES2VCC_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL0_RES2VCC_Pos)) /* Assignment of value for RES2VCC in the OPAMP_OPAMPCTRL0 register */
...
#define OPAMP_OPAMPCTRL0_RES1EN(value)        (OPAMP_OPAMPCTRL0_RES1EN_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL0_RES1EN_Pos)) /* Assignment of value for RES1EN in the OPAMP_OPAMPCTRL0 register */
...
#define OPAMP_OPAMPCTRL0_RES1MUX(value)       (OPAMP_OPAMPCTRL0_RES1MUX_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL0_RES1MUX_Pos)) /* Assignment of value for RES1MUX in the OPAMP_OPAMPCTRL0 register */
...
#define OPAMP_OPAMPCTRL0_POTMUX(value)        (OPAMP_OPAMPCTRL0_POTMUX_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL0_POTMUX_Pos)) /* Assignment of value for POTMUX in the OPAMP_OPAMPCTRL0 register */
...
#define OPAMP_OPAMPCTRL0_MUXPOS(value)        (OPAMP_OPAMPCTRL0_MUXPOS_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL0_MUXPOS_Pos)) /* Assignment of value for MUXPOS in the OPAMP_OPAMPCTRL0 register */
...
#define OPAMP_OPAMPCTRL0_MUXNEG(value)        (OPAMP_OPAMPCTRL0_MUXNEG_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL0_MUXNEG_Pos)) /* Assignment of value for MUXNEG in the OPAMP_OPAMPCTRL0 register */
...
#define OPAMP_OPAMPCTRL1_ENABLE(value)        (OPAMP_OPAMPCTRL1_ENABLE_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL1_ENABLE_Pos)) /* Assignment of value for ENABLE in the OPAMP_OPAMPCTRL1 register */
...
#define OPAMP_OPAMPCTRL1_ANAOUT(value)        (OPAMP_OPAMPCTRL1_ANAOUT_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL1_ANAOUT_Pos)) /* Assignment of value for ANAOUT in the OPAMP_OPAMPCTRL1 register */
...
#define OPAMP_OPAMPCTRL1_BIAS(value)          (OPAMP_OPAMPCTRL1_BIAS_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL1_BIAS_Pos)) /* Assignment of value for BIAS in the OPAMP_OPAMPCTRL1 register */
...
#define OPAMP_OPAMPCTRL1_RUNSTDBY(value)      (OPAMP_OPAMPCTRL1_RUNSTDBY_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL1_RUNSTDBY_Pos)) /* Assignment of value for RUNSTDBY in the OPAMP_OPAMPCTRL1 register */
...
#define OPAMP_OPAMPCTRL1_ONDEMAND(value)      (OPAMP_OPAMPCTRL1_ONDEMAND_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL1_ONDEMAND_Pos)) /* Assignment of value for ONDEMAND in the OPAMP_OPAMPCTRL1 register */
...
#define OPAMP_OPAMPCTRL1_RES2OUT(value)       (OPAMP_OPAMPCTRL1_RES2OUT_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL1_RES2OUT_Pos)) /* Assignment of value for RES2OUT in the OPAMP_OPAMPCTRL1 register */
...
#define OPAMP_OPAMPCTRL1_RES2VCC(value)       (OPAMP_OPAMPCTRL1_RES2VCC_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL1_RES2VCC_Pos)) /* Assignment of value for RES2VCC in the OPAMP_OPAMPCTRL1 register */
...
#define OPAMP_OPAMPCTRL1_RES1EN(value)        (OPAMP_OPAMPCTRL1_RES1EN_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL1_RES1EN_Pos)) /* Assignment of value for RES1EN in the OPAMP_OPAMPCTRL1 register */
...
#define OPAMP_OPAMPCTRL1_RES1MUX(value)       (OPAMP_OPAMPCTRL1_RES1MUX_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL1_RES1MUX_Pos)) /* Assignment of value for RES1MUX in the OPAMP_OPAMPCTRL1 register */
...
#define OPAMP_OPAMPCTRL1_POTMUX(value)        (OPAMP_OPAMPCTRL1_POTMUX_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL1_POTMUX_Pos)) /* Assignment of value for POTMUX in the OPAMP_OPAMPCTRL1 register */
...
#define OPAMP_OPAMPCTRL1_MUXPOS(value)        (OPAMP_OPAMPCTRL1_MUXPOS_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL1_MUXPOS_Pos)) /* Assignment of value for MUXPOS in the OPAMP_OPAMPCTRL1 register */
...
#define OPAMP_OPAMPCTRL1_MUXNEG(value)        (OPAMP_OPAMPCTRL1_MUXNEG_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL1_MUXNEG_Pos)) /* Assignment of value for MUXNEG in the OPAMP_OPAMPCTRL1 register */
...
#define OPAMP_OPAMPCTRL2_ENABLE(value)        (OPAMP_OPAMPCTRL2_ENABLE_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL2_ENABLE_Pos)) /* Assignment of value for ENABLE in the OPAMP_OPAMPCTRL2 register */
...
#define OPAMP_OPAMPCTRL2_ANAOUT(value)        (OPAMP_OPAMPCTRL2_ANAOUT_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL2_ANAOUT_Pos)) /* Assignment of value for ANAOUT in the OPAMP_OPAMPCTRL2 register */
...
#define OPAMP_OPAMPCTRL2_BIAS(value)          (OPAMP_OPAMPCTRL2_BIAS_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL2_BIAS_Pos)) /* Assignment of value for BIAS in the OPAMP_OPAMPCTRL2 register */
...
#define OPAMP_OPAMPCTRL2_RUNSTDBY(value)      (OPAMP_OPAMPCTRL2_RUNSTDBY_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL2_RUNSTDBY_Pos)) /* Assignment of value for RUNSTDBY in the OPAMP_OPAMPCTRL2 register */
...
#define OPAMP_OPAMPCTRL2_ONDEMAND(value)      (OPAMP_OPAMPCTRL2_ONDEMAND_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL2_ONDEMAND_Pos)) /* Assignment of value for ONDEMAND in the OPAMP_OPAMPCTRL2 register */
...
#define OPAMP_OPAMPCTRL2_RES2OUT(value)       (OPAMP_OPAMPCTRL2_RES2OUT_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL2_RES2OUT_Pos)) /* Assignment of value for RES2OUT in the OPAMP_OPAMPCTRL2 register */
...
#define OPAMP_OPAMPCTRL2_RES2VCC(value)       (OPAMP_OPAMPCTRL2_RES2VCC_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL2_RES2VCC_Pos)) /* Assignment of value for RES2VCC in the OPAMP_OPAMPCTRL2 register */
...
#define OPAMP_OPAMPCTRL2_RES1EN(value)        (OPAMP_OPAMPCTRL2_RES1EN_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL2_RES1EN_Pos)) /* Assignment of value for RES1EN in the OPAMP_OPAMPCTRL2 register */
...
#define OPAMP_OPAMPCTRL2_RES1MUX(value)       (OPAMP_OPAMPCTRL2_RES1MUX_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL2_RES1MUX_Pos)) /* Assignment of value for RES1MUX in the OPAMP_OPAMPCTRL2 register */
...
#define OPAMP_OPAMPCTRL2_POTMUX(value)        (OPAMP_OPAMPCTRL2_POTMUX_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL2_POTMUX_Pos)) /* Assignment of value for POTMUX in the OPAMP_OPAMPCTRL2 register */
...
#define OPAMP_OPAMPCTRL2_MUXPOS(value)        (OPAMP_OPAMPCTRL2_MUXPOS_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL2_MUXPOS_Pos)) /* Assignment of value for MUXPOS in the OPAMP_OPAMPCTRL2 register */
...
#define OPAMP_OPAMPCTRL2_MUXNEG(value)        (OPAMP_OPAMPCTRL2_MUXNEG_Msk & (_UINT32_(value) << OPAMP_OPAMPCTRL2_MUXNEG_Pos)) /* Assignment of value for MUXNEG in the OPAMP_OPAMPCTRL2 register */
...
/* OPAMP register offsets definitions */
